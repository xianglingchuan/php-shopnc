...
CREATE TABLE `#__inform` (
  ...
  `inform_store_id` int(11) NOT NULL COMMENT '被举报煤炭的店铺id',
...
CREATE TABLE `#__store_bind_class` (
  ...
  PRIMARY KEY (`bid`),
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺可发布煤炭类目表';
...
CREATE TABLE `#__store_extend` (
  ...
  `pricerange` text COMMENT '店铺统计设置的煤炭价格区间',
...
CREATE TABLE `#__store_goods_class` (
  ...
  `stc_name` varchar(50) NOT NULL COMMENT '店铺煤炭分类名称',
  `stc_parent_id` int(11) NOT NULL COMMENT '父级id',
  `stc_state` tinyint(1) NOT NULL DEFAULT '0' COMMENT '店铺煤炭分类状态',
  `store_id` int(11) NOT NULL DEFAULT '0' COMMENT '店铺id',
  `stc_sort` int(11) NOT NULL DEFAULT '0' COMMENT '煤炭分类排序',
  PRIMARY KEY (`stc_id`),
  KEY `stc_parent_id` (`stc_parent_id`,`stc_sort`),
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺煤炭分类表';
