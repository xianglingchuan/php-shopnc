...
<div class="wrap">
  ...
  <div class="ncm-security-container">
    ...
    <dl id="email" class="<?php echo $output['member_info']['member_email_bind'] == 1 ? 'yes' : 'no';?>">
      ...
      <dd><span class="explain">进行邮箱验证后，可用于接收敏感操作的身份验证信息，以及订阅更优惠煤炭的促销邮件。</span><span class="handle"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_security&op=auth&type=modify_email" class="ncm-btn ncm-btn-acidblue bd">绑定邮箱</a><a href="index.php?act=member_security&op=auth&type=modify_email" class="ncm-btn ncm-btn-orange jc">修改邮箱</a></span></dd>
    </dl>
