  ...
  <div id="browseMark" class="normal">
    <div class="outline">
      ...
      <div class="ncm-browse-mark">
            ...
            <div class="more"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_goodsbrowse&op=list" target="_blank">查看所有煤炭</a></div>
          </div>
       <?php } else { ?>
          <dl class="null-tip">
            <dt></dt>
            <dd>
              <h4>您的煤炭浏览记录为空</h4>
              <h5>赶紧去商城看看促销活动吧</h5>
              <p><a target="_blank" href="<?php echo SHOP_SITE_URL;?>" class="ncm-btn-mini">浏览煤炭</a></p>
            </dd>
          </dl>
       <?php } ?>
    </div>
