...
<div id="ncToolbar" class="nc-appbar">
  <div class="nc-appbar-tabs" id="appBarTabs">
    ...
    <ul class="tools">
      <li><a href="javascript:void(0);" id="chat_show_user" class="chat">三号线<i id="new_msg" class="new_msg" style="display:none;"></i></a></li>
      <?php if (!$output['hidden_rtoolbar_cart']) { ?>
      <li><a href="javascript:void(0);" id="rtoolbar_cart" class="cart">采购平台<i id="rtoobar_cart_count" class="new_msg" style="display:none;"></i></a></li>
      <?php } ?>
  ...
  <div class="topbar wrapper">
    ...
    <div class="quick-menu">
      ...
      <dl>
        ...
        <dd>
          <ul>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_favorites&op=fglist">煤炭收藏</a></li>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_favorites&op=fslist">煤企收藏</a></li>
          </ul>
        </dd>
      </dl>
      <dl>
