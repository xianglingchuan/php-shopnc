      ...
      <div class="ncs-key">
        ...
        <dl>
          ...
          <dd class="ncs-figure-input">
            ...
            <span style="margin-left: 5px;">（每个F码优先购买一件煤炭）</span>(<?php echo $lang['goods_index_stock'];?><em nctype="goods_stock"><?php echo $output['goods']['goods_storage']; ?></em><?php echo $lang['nc_jian'];?>)
            <?php } else {?>
      ...
      <div class="ncs-intro">
        <div class="content bd" id="ncGoodsIntro">
          ...
          <ul class="nc-goods-sort">
            <li>企业货号：<?php echo $output['goods']['goods_serial'];?></li>
        ...
        <div class="ncs-goods-info-content bd" id="ncGoodsRate">
          <div class="top">
            ...
            <div class="btns"><span>您可对已购煤炭进行评价</span>
              <p><a href="<?php if ($output['goods']['is_virtual']) { echo urlShop('member_vr_order', 'index');} else { echo urlShop('member_order', 'index');}?>" class="ncs-btn ncs-btn-red" target="_blank"><i class="icon-comment-alt"></i>评价</a></p>
            </div>
          </div>
          <div class="ncs-goods-title-nav">
            <ul id="comment_tab">
      ...
      <div class="ncs-sidebar-container">
        ...
        <div class="content">
          <div class="ncs-goods-code">
            <p><img src="<?php echo goodsQRCode($output['goods']);?>"  title="煤炭原始地址：<?php echo urlShop('goods', 'index', array('goods_id'=>$output['goods']['goods_id']));?>"></p>
