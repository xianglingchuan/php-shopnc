...
<div class="nch-container wrapper">
  <div class="nch-all-menu">
    <ul class="tab-bar">
      <li><a href="<?php echo urlShop('category', 'index');?>">全部煤炭分类</a></li>
      <li class="current"><a href="javascript:void(0);">全部煤炭企业</a></li>
      <li><a href="<?php echo urlShop('search', 'index');?>">全部煤炭</a></li>
    </ul>
  </div>
  ...
  <div class="nch-brand-class">
    ...
    <div class="nch-barnd-list tabs-panel <?php if ($i != 1) { echo 'tabs-hide';} ?>">
      ...
      <?php if ($brand_c['text']){?>
      <div class="nch-barnd-list-text"><strong>更多煤炭企业：</strong>
