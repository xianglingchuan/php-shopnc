...
<?php if (C('pointprod_isuse')==1){?>
<div class="ncp-memeber-pointcart"> <a href="index.php?act=pointcart" class="btn">礼品兑换采购平台<?php if ($output['pointcart_count'] > 0){?><em><?php echo $output['pointcart_count']; ?></em><?php } ?></a></div>
<?php }?>
