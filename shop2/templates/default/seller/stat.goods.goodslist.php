...
<div class="alert mt10" style="clear:both;">
	<ul class="mt5">
		...
		<li>2、以下列表为从昨天开始最近30天有效订单中的所有煤炭数据</li>
        <li>3、近30天下单煤炭数：从昨天开始最近30天有效订单的某煤炭总销量</li>
        <li>4、近30天下单金额：从昨天开始最近30天有效订单的某煤炭总销售额</li>
        <li>5、点击每列旁边的箭头对列表进行排序，默认按照“近30天成交件数”降序排列</li>
        <li>6、点击每条记录后的“走势图”，查看最近30天下单金额、下单煤炭数、下单量走势</li>
      </ul>
</div>
  ...
  <table class="search-form">
    ...
    <tr>
    	<td class="tr">
    		...
    		<div class="fr">煤炭分类&nbsp;<span id="searchgc_td"></span><input type="hidden" id="choose_gcid" name="choose_gcid" value="0"/></div>
    	</td>
    </tr>
  </table>
</form>
<table class="ncsc-default-table">
  <thead>
    <tr class="sortbar-array">
      ...
      <th>煤炭名称</th>
      <th>价格</th>
      <th class="align-center"><a title="点击进行排序" nc_type="orderitem" data-param='{"orderby":"ordergoodsnum"}' class="<?php echo (!$output['orderby'] || $output['orderby']=='ordergoodsnum desc')?'selected desc':''; echo $output['orderby']=='ordergoodsnum asc'?'selected asc':''; ?>">近30天下单煤炭数<i></i></a></th>
