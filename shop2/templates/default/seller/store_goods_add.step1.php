...
<div class="wrapper_search">
  ...
  <div class="wp_confirm">
    <form method="get">
      ...
      <div class="bottom tc">
      <label class="submit-border"><input disabled="disabled" nctype="buttonNextStep" value="<?php echo $lang['store_goods_add_next'];?>，填写煤炭信息" type="submit" class="submit"style=" width: 200px;" /></label>
      </div>
    </form>
  </div>
</div>
