...
<div class="alert mt10"> <strong><?php echo $lang['nc_explain'].$lang['nc_colon'];?></strong> 只能查询“<?php echo $output['minDate']; ?>”到“<?php echo $output['maxDate']; ?>”的三号线记录，切换不同的选项卡选择可查看与店铺客服最近对话的会员。 </div>
<div class="tabmenu">
