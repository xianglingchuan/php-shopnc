...
class store_promotion_xianshiControl extends BaseSellerControl {
    ...
    public function xianshi_goods_addOp() {
        ...
        if($xianshi_goods_info) {
            ...
            $this->recordSellerLog('添加限时折扣煤炭，活动名称：'.$xianshi_info['xianshi_name'].'，煤炭名称：'.$goods_info['goods_name']);
    ...
    public function xianshi_goods_price_editOp() {
        ...
        if($result) {
            ...
            $this->recordSellerLog('限时折扣价格修改为：'.$xianshi_goods_info['xianshi_price'].'，煤炭名称：'.$xianshi_goods_info['goods_name']);
        } else {
            $data['result'] = false;
    ...
    public function xianshi_goods_deleteOp() {
        ...
        $this->recordSellerLog('删除限时折扣煤炭，活动名称：'.$xianshi_info['xianshi_name'].'，煤炭名称：'.$xianshi_goods_info['goods_name']);
        echo json_encode($data);die;
    }
