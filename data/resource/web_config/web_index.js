...
//企业相关
function select_brand(brand_id) {//企业选择
...
function get_recommend_brand() {//查询企业
...
function del_brand(brand_id) {//删除已选企业
	var obj = $("img[select_brand_id='"+brand_id+"']");
	obj.parent().parent().parent().remove();
}
function update_brand() {//更新企业
