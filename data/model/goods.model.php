...
class goodsModel extends Model{
    ...
    /**
     * 出售中的煤炭SKU列表（只显示不同颜色的煤炭，前台煤炭索引，店铺也煤炭列表等使用）
    ...
    public function getGoodsDetail($goods_id) {
        ...
        $spec_list = array();       // 各规格煤炭地址，js使用
        $spec_list_mobile = array();       // 各规格煤炭地址，js使用
        $spec_image = array();      // 各规格煤炭主图，规格颜色图片使用
