...
class queueLogic {
    ...
    public function createOrderUpdateStorage($goods_buy_quantity) {
        ...
        if (!$result) {
            return callback(false,'变更煤炭库存与销量失败');
        } else {
            return callback(true);
        }
    }
    ...
    public function updateGoodsPromotionPriceByGoodsId($goods_id) {
        ...
        if (!$update) {
            return callback(false,'根据煤炭ID更新促销价格失败');
        } else {
            return callback(true);
        }
    }
    ...
    public function updateGoodsPromotionPriceByGoodsCommonId($goods_commonid) {
        ...
        if (!$update) {
            return callback(false,'根据煤炭公共id更新促销价格失败');
        } else {
            return callback(true);
        }
    }
    ...
    public function createGoodsFCode($param) {
        ...
        if (!empty($insert)) {
            ...
            if (!$insert) {
                return callback(false,'生成煤炭F码失败goods_commonid:'.$param['goods_commonid']);
            }
        }
        return callback(true);
    }
