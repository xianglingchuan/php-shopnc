...
<div class="ncm-flow-layout">
  <div class="ncm-flow-container">
    ...
    <div class="alert">
      <h4>操作提示：</h4>
      <ul>
        <li>1. 若您对订单进行支付后想取消购买且与企业达成一致退款，请填写<em>“订单退款”</em>内容并提交。</li>
        <li>2. 成功完成退款/退货；经过平台审核后，会将退款金额以<em>“预存款”</em>的形式返还到您的余额账户中（充值卡部分只能退回到充值卡余额）。</li>
      </ul>
    </div>
