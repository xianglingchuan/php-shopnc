...
<div id="favoritesGoods" class="double">
  <div class="outline">
    ...
    <div class="ncm-favorites-goods">
      ...
      <div class="more"><a target="_blank" href="index.php?act=member_favorites&op=fglist">查看收藏的所有煤炭</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
...
<div id="favoritesStore" class="normal">
  <div class="outline">
    ...
    <div class="ncm-favorites-store">
      ...
      <div class="more"><a target="_blank" href="index.php?act=member_favorites&op=fslist">查看收藏的所有煤企</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
