        ...
        <li>
          ...
          <dl class="ncm-goods-info">
            <dt><a href="<?php echo urlShop('member_order','show_order',array('order_id'=>$order_info['order_id'])); ?>" target="_blank"><?php echo $order_info['extend_order_goods'][0]['goods_name']; ?></a>
              ...
              <span>等<strong><?php echo count($order_info['extend_order_goods']);?></strong>种煤炭</span>
              <?php } ?>
            </dt>
      ...
      <ul>
        ...
        <li>
          ...
          <dl class="ncm-goods-info">
            ...
            <dd><span class="ncm-order-price">平台价：<em>￥<?php echo $cart_info['goods_price']; ?></em></span><!-- <span class="sale">限时折扣</span> --></dd>
          </dl>
        </li>
        <?php } ?>
      </ul>
      <div class="more"><a href="index.php?act=cart">查看采购平台所有煤炭</a></div>
    </div>
    <?php } else { ?>
    <dl class="null-tip">
      <dt></dt>
