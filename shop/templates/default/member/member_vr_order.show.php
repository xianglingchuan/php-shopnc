  ...
  <div class="ncm-order-info">
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        ...
        <li>2. 去平台看看有没有新的<a href="<?php echo urlShop('search','index');?>" class="ncm-btn-mini ncm-btn-green" target="_blank">虚拟煤炭</a>。</li>
      </ul>
    </div>
    <?php }?>
      ...
      <tbody>
        ...
        <tr>
          ...
          <?php if ($output['order_info']['if_cancel']){ ?>
            ...
            <p><a href="javascript:void(0)" nc_type="sharegoods" data-param='{"gid":"<?php echo $output['order_info']['goods_id'];?>"}'>分享煤炭</a></p>
            <?php } ?>
          </td>
        </tr>
      </tbody>
