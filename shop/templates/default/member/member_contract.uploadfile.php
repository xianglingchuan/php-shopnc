  ...
  <div class="adds">
    ...
    <form method="post" action="index.php?act=member_contract&op=signShowFile" id="address_form" target="_blank">
      ...
      <dl>
        <dt>认证类型</dt>
        <dd>
          <input type="text" class="text w100" name="authType" value="<?php echo $output['data']['authType'];?>"/>
      ...
      <dl>
        <dt>签署账户标识信息类型</dt>
        <dd>
          <input type="text" class="text w100" name="signerType" value="<?php echo $output['data']['signerType'];?>"/>
      ...
      <dl>
        <dt>客户自定义标识：</dt>
        <dd>
          <input type="text" class="text w100" name="customNum" value="<?php echo $output['data']['customNum'];?>"/>
        </dd>
      </dl>      
      <dl>
        <dt>同步通知地址</dt>
        <dd>
          <input type="text" class="text w100" name="redirectUrl" value="<?php echo $output['data']['redirectUrl'];?>"/>
        </dd>
      </dl>  
      <dl>
        <dt>异步通知地址</dt>
        <dd>
          <input type="text" class="text w100" name="notifyUrl" value="<?php echo $output['data']['notifyUrl'];?>"/>
        </dd>
      </dl>        
