...
<div class="breadcrumb"><span class="icon-home"></span><span><a href="<?php echo SHOP_SITE_URL;?>">首页</a></span> <span class="arrow">></span> <span>企业入驻申请</span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3>企业入驻申请</h3>
      ...
      <dl show_id="0">
        ...
        <dd>
          <ul>
            ...
            <li class="<?php echo $output['step'] == '3' ? 'current' : '';?>"><i></i>煤企经营信息</li>
          </ul>
        </dd>
      </dl>
      <dl>
  ...
  <div class="right-layout">
    <div class="joinin-step">
      <ul>
        ...
        <li class="<?php echo $output['step'] >= 3 ? 'current' : '';?>"><span>煤企经营信息</span></li>
        <li class="<?php echo $output['step'] >= 4 ? 'current' : '';?>"><span>合同签订及缴费</span></li>
        <li class="step6"><span>煤企开通</span></li>
      </ul>
    </div>
