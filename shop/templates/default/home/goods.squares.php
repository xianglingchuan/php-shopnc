  ...
  <ul class="list_pic">
    ...
    <li class="item">
      <div class="goods-content" nctype_goods=" <?php echo $value['goods_id'];?>" nctype_store="<?php echo $value['store_id'];?>">
        ...
        <div class="goods-promotion"><span>团购煤炭</span></div>
        ...
        <div class="goods-info">
          ...
          <div class="goods-sub">
            ...
            <span class="fcode" title="F码优先购买煤炭">F码优先</span>
            <?php }?>
            <?php if ($value['is_presell'] == 1) {?>
            <span class="presell" title="预售购买煤炭">预售</span>
            <?php }?>
          ...
          <div class="add-cart">
            ...
            <?php } else {?>
            <a href="javascript:void(0);" nctype="add_cart" data-param="{goods_id:<?php echo $value['goods_id'];?>}"><i class="icon-shopping-cart"></i>加入采购平台</a>
            <?php }?>
            <?php }?>
          </div>
        </div>
