  ...
  <form method="post" action="index.php?act=pointvoucher&op=voucherexchange_save" id="exform" onsubmit="ajaxpost('exform', '', '', 'onerror');">
    ...
    <dl>
      <dt>您正在使用<span class="ml5 mr5"><?php echo $output['template_info']['voucher_t_points'];?></span><?php echo$lang['points_unit'];?>&nbsp;兑换&nbsp;1&nbsp;张<br/>
        <?php echo $output['template_info']['store_name'];?><?php echo $output['template_info']['voucher_t_price'].$lang['currency_zh'];?>煤企代金券（<em>满<?php echo $output['template_info']['voucher_t_limit'];?>减<?php echo $output['template_info']['voucher_t_price'];?></em>）</dt>
      <dd>煤企代金券有效期至<?php echo @date('Y-m-d',$output['template_info']['voucher_t_end_date']);?></dd>
      <dd>
