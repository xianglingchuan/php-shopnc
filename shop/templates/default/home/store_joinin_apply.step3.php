...
<div id="apply_store_info" class="apply-store-info">
  <div class="alert">
    <h4>注意事项：</h4>
    煤企经营类目为平台煤炭分类，请根据实际运营情况添加一个或多个经营类目。</div>
  <form id="form_store_info" action="index.php?act=store_joinin&op=step4" method="post" >
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      <thead>
        <tr>
          <th colspan="20">煤企经营信息</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <th class="w150"><i>*</i>企业账号：</th>
          <td><input id="seller_name" name="seller_name" type="text" class="w200"/>
            <span></span>
            <p class="emphasis">此账号为日后登录并管理企业中心时使用，注册后不可修改，请牢记。</p></td>
        </tr>
        <tr>
          <th class="w150"><i>*</i>煤企名称：</th>
          <td><input name="store_name" type="text" class="w200"/>
            <span></span>
            <p class="emphasis">煤企名称注册后不可修改，请认真填写。</p></td>
        </tr>
        <tr>
          <th><i>*</i>煤企等级：</th>
          <td><select name="sg_id" id="sg_id">
              ...
              <?php $explain = '煤炭数：'.$goods_limit.' 模板数：'.$v['sg_template_number'].' 收费标准：'.$v['sg_price'].' 元/年 附加功能：'.$v['function_str'];?>
        ...
        <tr>
          ...
          <td><select name="sc_id" id="sc_id">
            ...
            <span></span>
            <p class="emphasis">请根据您所经营的内容认真选择煤企分类，注册后企业不可自行修改。</p></td>
        </tr>
        <tr>
          <th><i>*</i>经营类目：</th>
