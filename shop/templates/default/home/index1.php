...
<div class="home-focus-layout"> <?php echo $output['web_html']['index_pic'];?>
  <div class="right-sidebar">
    ...
    <div class="proclamation">
      ...
      <div class="tabs-panel"> <a href="<?php echo urlShop('show_joinin', 'index');?>" title="申请企业入驻；已提交申请，可查看当前审核状态。" class="store-join-btn" target="_blank">&nbsp;</a> <a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" class="store-join-help"><i class="icon-cog"></i>登录登陆企业管理中心</a> </div>
...
<div class="wrapper">
  <div class="mt10"><div class="mt10">
    <a title="三号线运输车辆监管平台广告" target="_blank" href="<?php echo DELIVERY_SITE_URL;?>">
      <img border="0" alt="三号线运输车辆监管平台广告" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_DELIVERY;?>/adv/banner.gif" style="width:1200px;height:100px">
    </a>
</div></div>
</div>
