...
(function (b) {
    ...
    a.fn.extend({
        setup: function () {
            ...
            if (this.settings.images_links.length > 1) {
                ...
                this.box_skitter.find(".image_number").hover(function () {
                    if (b(this).attr("class") != "image_number image_number_select") {
                        b(this).stop().animate(w.settings.animateNumberOver, 290)
                    }
                }, function () {
                    if (b(this).attr("class") != "image_number image_number_select") {
            ...
            var p = 290 / this.settings.velocity;
...
(function () {
    jQuery.noConflict();
    jQuery('#slideshow').skitter({ width: 788, height: 290, animation: 'random', structure: '<a href="#" class="prev_button">prev</a>' + '<a href="#" class="next_button">next</a>' + '<span class="info_slide"></span>' + '<div class="container_skitter">' + '<div class="image">' + '<a target="_blank" href="/"><img class="image_main" /></a>' + '<div class="label_skitter"></div>' + '</div>' + '</div>', velocity: 1.3, interval: 3100, thumb_width: '70px', thumb_height: '40px', caption: 'bottom', caption_width: '250', navigation: 1, fullscreen: false })
})();
