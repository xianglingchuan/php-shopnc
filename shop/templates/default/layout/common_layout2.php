...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    ...
    <div class="head-user-menu">
      <dl class="my-mall">
        <dt><span class="ico"></span><i class="arrow"></i></dt><!--我的平台-->
        <dd>
          <div class="sub-title">
          ...
          <div class="user-centent-menu">
            <ul>
              ...
              <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_voucher">合同(<span id="member_voucher">0</span>)</a></li>
              <?php } ?>
      ...
      <dl class="my-cart">
        ...
        <?php } ?>
        <dt><span class="ico"></span><i class="arrow"></i></dt><!--交易结算-->
        <dd>
          <div class="sub-title">
            <h4>最新加入的煤炭</h4>
          </div>
          ...
          <div class="checkout"> <span class="total-price">共<i><?php echo $output['cart_goods_num'];?></i><?php echo $lang['nc_kindof_goods'];?></span><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=cart" class="btn-cart">结算中心</a> </div>
        </dd>
      </dl>
    </div>
  </header>
