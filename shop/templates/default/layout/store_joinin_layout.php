...
<div class="header">
  ...
  <ul class="header_menu">
    <li class="<?php echo $output['show_sign']=='joinin' ? 'current':'';?>"><a href="<?php echo urlShop('show_joinin', 'index');?>" class="joinin"><i></i>企业入驻申请</a></li>
    <li class=""><a href="<?php echo urlShop('seller_center', 'index');?>" class="login"><i></i>登陆企业管理中心</a></li>
    <li class="<?php echo $output['show_sign']=='help' ? 'current':'';?>"><a href="<?php echo urlShop('show_help', 'index');?>" class="faq"><i></i>企业帮助指南</a></li>
  </ul>
</div>
