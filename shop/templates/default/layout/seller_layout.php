...
<div class="store-closed"><i class="icon-warning-sign"></i>
  <dl>
    ...
    <dd>在此期间，您的煤企以及煤炭将无法访问；如果您有异议或申诉请及时联系平台管理。</dd>
  </dl>
</div>
<?php } ?>
<header class="ncsc-head-layout w">
  <div class="wrapper">
    <div class="ncsc-admin">
      ...
      <div class="ncsc-admin-function"><a href="<?php echo urlShop('show_store', 'index', array('store_id'=>$_SESSION['store_id']), $output['store_info']['store_domain']);?>" title="前往煤企" ><i class="icon-home"></i></a><a href="<?php echo urlShop('member_security', 'auth',array('type'=>'modify_pwd'));?>" title="修改密码" target="_blank"><i class="icon-wrench"></i></a><a href="<?php echo urlShop('seller_logout', 'logout');;?>" title="安全退出"><i class="icon-signout"></i></a></div>
    </div>
    ...
    <div class="index-search-container">
      ...
      <div class="search-bar">
        <form method="get" target="_blank">
          ...
          <input type="text" nctype="search_text" name="keyword" placeholder="平台煤炭搜索" class="search-input-text">
...
<div class="ncsc-layout wrapper">
  ...
  <div id="layoutRight" class="ncsc-layout-right">
    <div class="ncsc-path"><i class="icon-desktop"></i>登陆企业管理中心<i class="icon-angle-right"></i><?php echo $output['current_menu']['model_name'];?><i class="icon-angle-right"></i><?php echo $output['current_menu']['name'];?></div>
