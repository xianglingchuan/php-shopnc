...
<?php if ($output['hidden_nctoolbar'] != 1) { ?>
    <div id="ncToolbar" class="nc-appbar hide">
            ...
            <?php } else { ?>
                ...
                <div class="user-login-box" nctype="barLoginBox" style="display:none;"><i class="arrow"></i> <a
                    ...
                    <form id="login_form" method="post" action="index.php?act=login&op=login"
                        ...
                        <dl>
                            <dt><strong>登录密码</strong><a href="index.php?act=login&op=forget_password" target="_blank">忘记登录密码？</a>
                            </dt>
                            <dd>
                        ...
                        <?php if (C('captcha_status_login') == '1') { ?>
                            <dl>
                                <dt><strong>验证码</strong><a href="javascript:void(0)" class="ml5"
                                                           onclick="javascript:document.getElementById('codeimage').src='<?php echo SHOP_SITE_URL ?>/index.php?act=seccode&op=makecode&nchash=<?php echo getNchash('login', 'index'); ?>&t=' + Math.random();">更换验证码</a>
                                </dt>
                                <dd>
                        ...
                        <div class="bottom">
                            ...
                            <a href="index.php?act=login&op=register&ref_url=<?php echo urlencode($output['ref_url']); ?>"
                               target="_blank">注册新用户</a></div>
                    </form>
                </div>
            <?php } ?>

            <ul class="tools">
                <li><a href="javascript:void(0);" id="chat_show_user" class="chat">三号线<i id="new_msg" class="new_msg"
                                                                                         style="display:none;"></i></a>
                </li>
                <?php if (!$output['hidden_rtoolbar_cart']) { ?>
                    <li><a href="javascript:void(0);" id="rtoolbar_cart" class="cart">采购平台<i id="rtoobar_cart_count"
                                                                                             class="new_msg"
                                                                                             style="display:none;"></i></a>
                    </li>
                <?php } ?>
...
<div class="public-top-layout w">
    <div class="topbar wrapper">
      ...
      <a href="<?php echo urlShop('member', 'home'); ?>"><?php echo $_SESSION['member_name']; ?></a>
                ...
                <span>[<a
                        href="<?php echo urlShop('login', 'logout'); ?>"><?php echo $lang['nc_logout']; ?></a>] </span>
            <?php } else { ?>
                <?php echo $lang['nc_hello'] . $lang['nc_comma'] . $lang['welcome_to_site']; ?><a
                    href="<?php echo SHOP_SITE_URL; ?>" title="<?php echo $lang['homepage']; ?>"
                    alt="<?php echo $lang['homepage']; ?>"><?php echo $output['setting_config']['site_name']; ?></a>
                <span style="margin-left: 15px;">[<a  style="color:#ca0000" href="<?php echo urlShop('login'); ?>"><?php echo $lang['nc_login']; ?></a>]</span><span style="margin-left: 15px;">[<a
                        href="<?php echo urlShop('login', 'register'); ?>"><?php echo $lang['nc_register']; ?></a>]</span>
            <?php } ?>
        </div>
        <div class="quick-menu">
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        <li><a href="<?php echo SHOP_SITE_URL; ?>/index.php?act=member_favorites&op=fglist">煤炭收藏</a>
                        </li>
                        <li><a href="<?php echo SHOP_SITE_URL; ?>/index.php?act=member_favorites&op=fslist">煤企收藏</a>
                        </li>
                    </ul>
                </dd>
            </dl>
