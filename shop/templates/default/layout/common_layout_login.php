...
<![endif]-->
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.head-user-menu .my-mall').mouseover(function () {// 最近浏览的煤炭
                load_history_information();
                $(this).unbind('mouseover');
            });
            $('.head-user-menu .my-cart').mouseover(function () {// 运行加载采购平台
...
<div class="header-wrap">
    <header class="public-head-layout wrapper" style="margin-top: 20px; margin-bottom: 20px;">
        <h1 class="site-logo" style="margin-left:-8%;"><a href="<?php echo SHOP_SITE_URL; ?>"><img
...
<!--       <div class="policys" style="float: left;">
      ...
      <form action="<?php echo SHOP_SITE_URL; ?>" method="get" class="search-form" id="top_search_form">
        ...
        <input name="keyword" id="keyword" type="text" class="input-text" value="<?php echo $_GET['keyword']; ?>" maxlength="60" x-webkit-speech lang="zh-CN" onwebkitspeechchange="foo()" placeholder="请输入您要搜索的煤炭关键字" x-webkit-grammar="builtin:search" />
      ...
      <div class="keyword"><?php echo $lang['hot_search'] . $lang['nc_colon']; ?>
        ...
        <div class="head-user-menu" style="display: none;">
                    ...
                    <div class="user-centent-menu">
                        <ul>
                            ...
                            <?php if (C('voucher_allow') == 1) { ?>
                                <li><a href="<?php echo SHOP_SITE_URL; ?>/index.php?act=member_voucher">煤金券(<span
            ...
            <dl class="my-cart">
                ...
                <?php } ?>
                <dt><span class="ico"></span>交易结算<i class="arrow"></i></dt>
                <dd>
                    <div class="sub-title">
                        <h4>最新加入的煤炭</h4>
                    </div>
                    ...
                    <div class="checkout"><span
                            ...
                            href="<?php echo SHOP_SITE_URL; ?>/index.php?act=cart" class="btn-cart">结算采购平台中的煤炭</a></div>
                </dd>
            </dl>
        </div>
	<div style="float:right;margin-top: 30px;width:250px; margin-right: -7%;" id="top_pho">
            <img src="http://www.zg03.com/shop/images/kf.png" style="width: 220px;  height: 70px;float: right;">
        </div>
	</header>
</div>
            ...
            <?php if (!empty($output['show_goods_class']) && is_array($output['show_goods_class'])) {
                foreach ($output['show_goods_class'] as $key => $val) { ?>
                    <li>
                        ...
                        ?>"<?php if (isset($_GET['cate_id']) && $_GET['cate_id'] == $val["gc_id"]) {
                            echo 'class="current"';
