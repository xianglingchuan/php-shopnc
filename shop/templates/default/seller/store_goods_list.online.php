  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="tl"><dl class="goods-name">
          ...
          <dd class="serve"> <span class="<?php if ($val['goods_commend'] == 1) { echo 'open';}?>" title="煤企推荐煤炭"><i class="commend">荐</i></span> <span class="<?php if ($val['mobile_body'] != '') { echo 'open';}?>" title="手机端煤炭详情"><i class="icon-tablet"></i></span> <span class="" title="煤炭页面二维码"><i class="icon-qrcode"></i>
