    ...
    <div class="basic-info">
      <dl class="ncsc-seller-info">
        ...
        <dd class="store-logo">
          ...
          <a href="<?php echo urlShop('store_setting', 'store_setting');?>"><i class="icon-edit"></i>编辑煤企设置</a> </dd>
