...
<div class="alert mt10"> <strong><?php echo $lang['nc_explain'].$lang['nc_colon'];?></strong> 只能查询“<?php echo $output['minDate']; ?>”到“<?php echo $output['maxDate']; ?>”的三号线记录，切换不同的选项卡选择可查看与煤企客服最近对话的会员。 </div>
<div class="tabmenu">
...
<script>
    ...
    function select_seller(seller_id){
        ...
        $("#store_chat_log").html('<div class="warning-option"><span>从左侧对话列表中选择会员显示三号线记录，使用“起止日期”进行时间段内的查询</span></div>');
    }
