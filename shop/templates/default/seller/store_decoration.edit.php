...
<div class="ncsc-path"><i class="icon-desktop"></i>登陆企业管理中心<i class="icon-angle-right"></i>煤企<i class="icon-angle-right"></i>煤企装修<i class="icon-angle-right"></i>页面设计</div>
<div class="ncsc-decoration-layout">
  ...
  <div id="store_decoration_content" style="<?php echo $output['decoration_background_style'];?>">
    ...
    <div id="decoration_nav" class="ncsl-nav">
      <div class="ncs-nav">
        <ul>
          <li class="active"><a href="javascript:void(0);"><span>煤企首页<i></i></span></a></li>
          <li><a href="javascript:void(0);"><span>煤企动态<i></i></span></a></li>
        </ul>
      </div>
    </div>
      ...
      <dl>
        ...
        <dd>
          ...
          <label for="decoration_nav_display_false">
            ...
            不显示</label>
          <p class="hint">“头部导航”为煤企首页煤企导航条，可设置是否显示， 默认为显示。</p>
        </dd>
      </dl>
      <dl>
        <dt>导航样式：</dt>
      ...
      <dl>
        ...
        <dd>
          ...
          <label for="decoration_banner_display_false">
            ...
            不显示</label>
          <p class="hint">“头部图片”为煤企首页最上方图片，可设置是否显示。</p>
        </dd>
      </dl>
      <dl>
        <dt>图片：</dt>
...
<div id="dialog_module_goods" class="eject_con dialog-decoration-edit" style="display:none;">
  <div class="alert">
    <ul>
      <li>1. 搜索煤企内在售煤炭并“选择添加”，设置窗口上部将出现已选择的煤炭列表，也可对其进行“取消选择”操作，点击保存设置后生效。</li>
      <li>2. 当已选择的煤炭超过10个时，系统默认未全部显示，可通过在已选区域滚动鼠标或拉动侧边条进行查看及操作。</li>
    </ul>
  </div>
  ...
  <h4 class="mt10">煤企在售煤炭选择</h4>
  <div class="decoration-search-goods">
    <div class="search-bar">输入煤炭关键字：
      <input id="txt_goods_search_keyword" type="text" class="text w200 vm" name="">
      <a id="btn_module_goods_search" class="ncsc-btn" href="javascript:void(0);">搜索</a><span class="ml10 orange">小提示： 留空搜索显示煤企全部在售煤炭，每页显示10个。</span></div>
