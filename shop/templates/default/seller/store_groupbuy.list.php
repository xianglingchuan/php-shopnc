...
<?php if ($output['isOwnShop']) { ?>
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:100px" class="ncsc-btn ncsc-btn-green" title="新增虚拟煤炭团购"><i class="icon-plus-sign"></i>新增虚拟团购</a>
...
<?php } else { ?>
  ...
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add_vr'); ?>" style="right:200px" class="ncsc-btn ncsc-btn-green" title="新增虚拟煤炭团购"><i class="icon-plus-sign"></i>新增虚拟团购</a>
...
<div class="alert alert-block mt10">
  <ul class="mt5">
    ...
    <li>2、如发布虚拟煤炭的团购活动，请点击新增虚拟团购按钮</li>
  </ul>
</div>
<?php } else { ?>
<div class="alert alert-block mt10">
  ...
  <ul class="mt5">
    ...
    <li>3、如发布虚拟煤炭的团购活动，请点击新增虚拟团购按钮</li>
    <li>4、<strong style="color: red">相关费用会在煤企的账期结算中扣除</strong></li>
  </ul>
</div>
<?php } ?>
    ...
    <tr class="bd-line">
      ...
      <td class="tl">
        <dl class="goods-name">
          <dt>
<?php if ($group['is_vr']) { ?>
            <span title="虚拟兑换煤炭" class="type-virtual">虚拟团</span>
<?php } ?>
