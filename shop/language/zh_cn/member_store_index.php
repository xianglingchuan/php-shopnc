 ...
 * 共有语言
 */
$lang['store_storeinfo_error']			= '煤企信息错误';
/**
 * 开店
 */
$lang['store_create_right_closed']		= '暂时关闭了申请煤企的权限';
$lang['store_create_created']			= '您已经创建了煤企，不能重复创建';
$lang['store_create_grade_not_exists']	= '错误的操作，该等级不存在';
$lang['store_create_choose_store_class']	= '选择煤企类型';
$lang['store_create_input_owner_info']	= '填写店主和煤企信息';
$lang['store_create_finish']			= '完成';
$lang['store_create_goods_num']			= '煤炭数';
...
$lang['store_create_input_store_name']	= '请输入煤企名称';
$lang['store_create_store_name_exists']	= '该煤企名称已经存在，请您更换一个店面名称';
...
$lang['store_create_choose_store_class']	= '请选择煤企分类';
...
$lang['store_create_store_name']		= '煤企名称';
$lang['store_create_name_rule']			= '请控制在20个字符以内';
$lang['store_create_store_class']		= '煤企分类';
...
$lang['store_create_true_store_intro']	= '什么是实体煤企认证';
...
$lang['store_save_store_name_null']		= '煤企名称不能为空';
$lang['store_save_store_class_null']	= '煤企分类不能为空';
$lang['store_save_area_null']			= '地区不能为空';
$lang['store_save_create_success']		= '恭喜您，您的煤企创建成功。';
$lang['store_save_create_fail']			= '创建煤企失败';
...
$lang['store_goods_class_no_record']	= '没有煤炭分类';
...
$lang['store_goods_class_problem']		= '导出您煤企分类的数据';
...
$lang['store_goods_class_modify_fail']	= '煤企分类修改失败';
$lang['store_goods_class_add_fail']		= '煤企分类添加失败';
...
$lang['store_order_goods_detail']		= '煤炭';
...
$lang['store_order_modify_price_gpriceerror']	= '煤炭总价不能为空且必须为数字';
...
$lang['store_show_order_store_name']	= '煤企名';
$lang['store_show_order_wangwang']		= '旺旺';
$lang['store_show_order_goods_name']	= '煤炭';
 ...
 * 煤企设置
 */
$lang['store_setting_name_null']			= '煤企名称不能为空';
...
$lang['store_create_store_name_hint']		= '煤企名称请控制长度不超过20字';
$lang['store_create_store_zy_hint']			= '关键字最多可输入50字，请用","进行分隔，例如”男装,女装,童装”';

$lang['store_setting_change_label']			= '煤企logo';
$lang['store_setting_label_tip']			= '此处理煤企页logo；<br/><span style="color:orange;">建议使用宽200像素-高60像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span>';
$lang['store_setting_change_avatar']		= '煤企头像';
$lang['store_setting_sign_tip']				= '此处为煤企方形头像；<br/><span style="color:orange;">建议使用宽100像素*高100像素内的方型图片；点击下方"提交"按钮后生效。</span>';
$lang['store_setting_change_banner']		= '煤企条幅';
$lang['store_setting_banner_tip']			= '此处为煤企页banner导航；<br/><span style="color:orange;">建议使用宽1000像素*高250像素的图片；点击下方"提交"按钮后生效。</span>';
...
$lang['store_setting_my_homepage']			= '我的煤企首页';
$lang['store_setting_grade']				= '煤企等级';
$lang['store_setting_upgrade']				= '马上升级煤企等级';
$lang['store_setting_location_tip']			= '不必重复填写所在地区';
$lang['store_setting_contact']				= '联系';
$lang['store_setting_wangwang']				= '阿里旺旺';
$lang['store_setting_intro']				= '煤企简介';
...
$lang['store_setting_store_zy']				= '主营煤炭';
$lang['store_setting_seo_description']		= 'SEO煤企描述';
$lang['store_setting_seo_keywords_help']	= '用于煤企搜索引擎的优化，关键字之间请用英文逗号分隔';
$lang['store_setting_seo_description_help']	= '用于煤企搜索引擎的优化，建议120字以内';
$lang['store_settine_browse']				= '浏览...';
$lang['store_setting_store_url']			= '当前煤企首页连接：';
/**
 * 升级煤企
 */
$lang['store_upgrade_submit']		= '煤企等级申请已提交给管理员，请您等待审核';
$lang['store_upgrade_submit_fail']	= '煤企等级提交失败，请重新操作';
$lang['store_upgrade_cur_grade']	= '煤企当前等级';
//$lang['store_upgrade_tip']			= '如果煤企等级需要审核，升级后在待审核这段期间，煤企部分功能不能正常使用，您确定要升级吗?';
$lang['store_upgrade_tip']			= '您确定要升级吗?';
$lang['store_upgrade_now']			= '马上申请';
$lang['store_upgrade_store_error']			= '煤企信息错误';
$lang['store_upgrade_gradesort_error']		= '等级错误,升级级别应高于当前级别';
$lang['store_upgrade_exist_error']			= '煤企等级升级申请已经提交，正在审核中，请耐心等待';
$lang['store_upgrade_exist_tip_1']			= '煤企等级升级为';
...
$lang['store_theme_homepage']			= '煤企首页';
$lang['store_theme_tpl_name']			= '煤企模版名称';
$lang['store_theme_style_name']			= '煤企风格名称';
...
$lang['store_activity_goods']		= '煤炭';
$lang['store_activity_group']		= '团购';
$lang['store_activity_join']		= '参与活动';
$lang['store_activity_no_record']	= '没有符合条件的活动';
$lang['store_activity_goods_name']	= '煤炭名称';
$lang['store_activity_goods_class']	= '煤炭类别';
$lang['store_activity_goods_brand']	= '煤炭煤企';
...
$lang['store_activity_brand']		= '煤企';
$lang['store_activity_name']		= '名称';
$lang['store_activity_search']		= '查找';
$lang['store_activity_goods_applied']	= '您的煤炭已经全部申请完毕';
$lang['store_activity_none_goods']		= '您尚未发布任何煤炭';
...
$lang['store_printsetup_tip2']			= '印章图片将出现在打印订单的右下角位置，请选择120x120px大小<br/>透明GIF/PNG格式图片上传作为您煤企的电子印章使用。';
$lang['store_printsetup_tip1']			= '打印备注信息将出现在打印订单的下方位置，用于注明煤企简介或发货、<br/>退换货相关规则等；<span class="orange">内容不要超过100字。</span>';
