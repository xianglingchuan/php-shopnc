...
$lang['group_goods_sel'] = '选择煤炭';
$lang['group_help'] = '团购说明';
$lang['start_time'] = '开始时间';
$lang['end_time'] = '结束时间';
$lang['goods_price'] = '煤炭原价';
$lang['goods_storage'] = '煤炭库存数';
$lang['store_price'] = '平台价';
$lang['groupbuy_price'] = '团购价格';
$lang['groupbuy_price_tip'] = '团购价格为该煤炭参加活动时的促销价格<br/>必须是0.01~1000000之间的数字(单位：元)';
...
$lang['groupbuy_class_tip'] = '请选择团购煤炭的所属类别';
$lang['groupbuy_area'] = '所属区域';
$lang['groupbuy_goods'] = '团购煤炭';
$lang['groupbuy_goods_explain'] = '点击上方输入框从已发布煤炭中选择要参加团购的煤炭';
...
$lang['max_num_explain'] = '团购煤炭总数应等于或小于该煤炭库存数量<br/>请提前确认要参与活动的煤炭库存数量足够充足';
...
$lang['group_goods_error'] = '请选择团购煤炭';
...
$lang['max_num_error'] = '煤炭总数不能为空，且必须小于当前库存';
$lang['groupbuy_none'] = '平台当前没有进行中的团购活动';
$lang['group_goods_is_exist'] = '该煤炭已经在本期团购活动中，请选择其它煤炭';
$lang['goods_info'] = '煤炭信息';
$lang['buyer_list'] = '购买记录';
$lang['store_info'] = '煤企信息';
$lang['groupbuy_not_state'] = '团购活动尚未开始';
$lang['groupbuy_closed'] = '团购活动已经结束';
$lang['goods_not_enough'] = '煤炭库存不足';
$lang['groupbuy_not_enough'] = '团购余额不足';
$lang['groupbuy_sale_quantity'] = '您最多只能购买';
$lang['can_not_buy'] = '您不能购买自己发布的煤炭';
...
$lang['text_piece'] = '件';
$lang['text_goods_buy'] = '本煤炭已被团购';
$lang['text_goods_store'] = '煤炭所在煤企';
$lang['text_goods_commend'] = '煤企推荐煤炭';
 ...
 * index
 */
$lang['groupbuy_index_no_right']			= '您的煤企等级没有此权限';
$lang['groupbuy_index_in_audit']			= '您的煤企等级正在审核中';
...
$lang['groupbuy_index_search_first']		= '请先搜索团购煤炭';
$lang['groupbuy_index_input_right_num']		= '请正确填写成团人数';
$lang['groupbuy_index_input_right_amount']	= '请正确填写成团吨数';
$lang['groupbuy_index_def_quantity_error']  = '请正确填写已订购数';
$lang['groupbuy_index_goods_sum_null']		= '煤炭总数不能为空';
$lang['groupbuy_index_goods_sum_one']		= '煤炭总数不能小于1';
...
$lang['groupbuy_index_end_time']			= '结束时间';
$lang['groupbuy_index_goods_info']			= '团购煤炭信息';
$lang['groupbuy_index_choose_goods']		= '选择煤炭';
...
$lang['groupbuy_index_group_amount']		= '成团吨数';
...
$lang['groupbuy_index_goods_sum']			= '煤炭总数';
$lang['groupbuy_index_amount_max_limit']	= '所有参团者最多能订购的数量，默认为煤炭库存数';
$lang['groupbuy_index_intro']				= '本团介绍';
$lang['groupbuy_index_spec_price']			= '规格价格';
$lang['groupbuy_index_spec']				= '规格';
$lang['groupbuy_index_stock']				= '库存';
$lang['groupbuy_index_store_price']			= '煤企价格';
...
$lang['groupbuy_index_no_record']			= '没有找到符合条件的煤炭';
$lang['groupbuy_index_loading_list']		= '正在加载煤炭列表';
$lang['groupbuy_index_no_goods']			= '没有找到相关煤炭';
$lang['groupbuy_index_choose_goods']		= '选择煤炭';
...
$lang['groupbuy_index_group_canceled']			= '团购煤炭已取消';
$lang['groupbuy_index_modify_intro_success']	= '修改煤炭说明成功';
$lang['groupbuy_index_modify_order_num_sucess']	= '修改煤炭订购数成功';
