...
$lang['xianshi_title_explain'] = '活动标题是商家对限时折扣活动的别名操作，请使用例如“新品打折”、“月末折扣”类短语表现，最多可输入10个字符；<br/>非必填选项，留空煤炭优惠价格前将默认显示“限时折扣”字样。';
$lang['xianshi_explain_explain'] = '活动描述是商家对限时折扣活动的补充说明文字，在煤炭详情页-优惠信息位置显示；<br/>非必填选项，最多可输入30个字符。';
