 ...
 * 添加活動
 */
$lang['bundling_add_explain1']				= '您只能發佈%d個組合銷售活動；每個活動最多可以添加%d個煤炭。';
$lang['bundling_add_explain2']				= '每個活動最多可以添加%d個煤炭。';
$lang['bundling_add_goods_explain']			= '搭配銷售的煤炭名稱可<br/>自定義編輯，上下拖移<br/>煤炭列可自定義顯示排<br/>序；編輯、刪除、排序<br/>等操作提交後生效。';
$lang['bundling_goods']						= '搭配煤炭';
$lang['bundling_show_name']					= '顯示名稱';
$lang['bundling_cost_price']				= '原價';
$lang['bundling_cost_price_note']			= '&nbsp;(已添加搭配煤炭的預設價格總計)';
$lang['bundling_operate']					= '操作';
$lang['bundling_goods_add']					= '添加煤炭';
$lang['bundling_add_price']					= '組合銷售價格';
$lang['bundling_add_price_title']			= '自定義組合銷售煤炭的優惠價格總計';
...
$lang['bundling_add_goods_error']			= '請選擇煤炭';
 ...
 * 活動列表
 */
$lang['bundling_list_goods_count']			= '煤炭數量';