...
class statistics_flowControl extends BaseSellerControl{
    ...
    public function storeflowOp() {
        ...
        //确定统计分表名称
		$last_num = $store_id % 10; //获取煤企ID的末位数字
	...
	private function profile_menu($menu_key='') {
        $menu_array	= array(
            1=>array('menu_key'=>'storeflow','menu_name'=>'煤企总流量','menu_url'=>'index.php?act=statistics_flow&op=storeflow'),
            2=>array('menu_key'=>'goodsflow','menu_name'=>'煤炭流量排名','menu_url'=>'index.php?act=statistics_flow&op=goodsflow')
        );
