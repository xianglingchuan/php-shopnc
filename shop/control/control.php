<?php
/**
 * 前台control父类,煤企control父类,会员control父类
 *
 *
...
class Control{
    ...
    protected function showLayout() {
        ...
        Tpl::output('show_goods_class',$goods_class);//煤炭分类
    ...
    protected function showCartCount() {
        if (cookie('cart_goods_num') != null){
            ...
            $cart_num = Model('cart')->getCartNum($save_type,array('buyer_id'=>$_SESSION['member_id']));//查询购物车煤炭种类
        }
...
class BaseMemberControl extends Control {
    ...
    protected function _getCommonOperationsAndNavLink ($act = '') {
        ...
        if ($nav == '') {
            $nav_link[] = array('title' => '我的平台');
        } else {
            $nav_link[] = array('title' => '我的平台',  'link' => urlShop('member', 'home'));
    ...
    private function _getMenuList() {
        $menu_list = array(
                'trade' => array('name' => '交易管理', 'child' => array(
                        'member_order'      => array('name' => '订单', 'url'=>urlShop('member_order', 'index')),
                        'member_vr_order'   => array('name' => '合同订单', 'url'=>urlShop('member_vr_order','index')),
                ...
                'serv' => array('name' => '客户服务', 'child' => array(
                        ...
                        'member_consult'    => array('name' => '煤炭咨询', 'url'=>urlShop('member_consult', 'my_consult')),
...
class BaseSellerControl extends Control {
    ...
    private function _getMenuList() {
        $menu_list = array(
            'goods' => array('name' => '煤炭', 'child' => array(
                array('name' => '煤炭发布', 'act'=>'store_goods_add', 'op'=>'index'),
                array('name' => '出售中的煤炭', 'act'=>'store_goods_online', 'op'=>'index'),
                array('name' => '仓库中的煤炭', 'act'=>'store_goods_offline', 'op'=>'index'),
                array('name' => '关联版式', 'act'=>'store_plate', 'op'=>'index'),
                array('name' => '煤炭规格', 'act' => 'store_spec', 'op' => 'index'),
                array('name' => '图片空间', 'act'=>'store_album', 'op'=>'album_cate'),
            )),
            'order' => array('name' => '订单物流', 'child' => array(
                array('name' => '交易订单', 'act'=>'store_order', 'op'=>'index'),
				array('name' => '长线合同订单', 'act'=>'store_vr_order', 'op'=>'index'),
            ...
            // )),
            'store' => array('name' => '煤企', 'child' => array(
                array('name' => '煤企设置', 'act'=>'store_setting', 'op'=>'store_setting'),
                array('name' => '煤企装修', 'act'=>'store_decoration', 'op'=>'decoration_setting'),
                array('name' => '煤企导航', 'act'=>'store_navigation', 'op'=>'navigation_list'),
                array('name' => '煤企动态', 'act'=>'store_sns', 'op'=>'index'),
                array('name' => '煤企信息', 'act'=>'store_info', 'op'=>'bind_class'),
                array('name' => '煤企分类', 'act'=>'store_goods_class', 'op'=>'index'),
                array('name' => '线下商铺', 'act'=>'store_live', 'op'=>'store_live'),
                array('name' => '煤企申请', 'act'=>'store_brand', 'op'=>'brand_list'),
            )),
            ...
            'statistics' => array('name' => '统计结算', 'child' => array(
                array('name' => '煤企概况', 'act'=>'statistics_general', 'op'=>'general'),
                array('name' => '煤炭分析', 'act'=>'statistics_goods', 'op'=>'goodslist'),
                ...
                array('name' => '订单结算', 'act'=>'store_bill', 'op'=>'index'),
                array('name' => '合同结算', 'act'=>'store_vr_bill', 'op'=>'index'),
            )),
            ...
            'account' => array('name' => '账号', 'child' => array(
                ...
                array('name' => '煤企消费', 'act'=>'store_cost', 'op'=>'cost_list'),
            ))
        );
        return $menu_list;
    }
