...
class statistics_goodsControl extends BaseSellerControl {
	...
	public function goodsinfoOp(){
		...
		$stat_arr['ordergoodsnum']['series'][0]['name'] = '下单煤炭数';
		$stat_arr['ordergoodsnum']['series'][0]['data'] = array_values($stat_list['ordergoodsnum']);
		$stat_arr['ordergoodsnum']['title'] = '最近30天下单煤炭数走势';
	...
	public function hotgoodsOp(){
		...
		$stat_arr['series'][0]['name'] = '下单煤炭数';
		$stat_arr['legend']['enabled'] = false;
		//得到统计图数据
		$stat_arr['title'] = '热卖煤炭TOP'.$topnum;
        $stat_arr['yAxis'] = '下单煤炭数';
	...
	private function profile_menu($menu_key='') {
        $menu_array	= array(
            1=>array('menu_key'=>'goodslist','menu_name'=>'煤炭详情',	'menu_url'=>'index.php?act=statistics_goods&op=goodslist'),
            2=>array('menu_key'=>'price','menu_name'=>'价格销量',	'menu_url'=>'index.php?act=statistics_goods&op=price'),
            3=>array('menu_key'=>'hotgoods','menu_name'=>'热卖煤炭',	'menu_url'=>'index.php?act=statistics_goods&op=hotgoods'),
        );
