        ...
        if (cookie('comparegoods')) {//如果cookie已经存在
            ...
            if ($comparegoods_str){
                ...
                if (count($comparegoods_arr) >= self::MAXNUM){
                    exit(json_encode(array('done'=>false,'msg'=>'对比栏已满，您可以删除不需要的栏内煤炭再继续添加哦！')));
                }
