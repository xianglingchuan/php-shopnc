...
class buyControl extends BaseBuyControl {
    ...
    public function buy_step1Op() {
        ...
        //返回需要计算运费的煤企ID数组 和 不需要计算运费(满免运费活动的)煤企ID及描述
    ...
    /**
     * 选择不同地区时，异步处理并返回每个煤企总运费以及本地区是否能使用货到付款
     * 如果煤企统一设置了满免运费规则，则运费模板无效
     * 如果煤企未设置满免规则，且使用运费模板，按运费模板计算，如果其中有煤炭使用相同的运费模板，则两种煤炭数量相加后再应用该运费模板计算（即作为一种煤炭算运费）
     * 如果未找到运费模板，按免运费处理
