...
class member_vr_buyControl extends mobileMemberControl {
     ...
     * 虚拟煤炭购买第二步，设置接收手机号
	 * POST
	 * 传入：goods_id:煤炭ID，quantity:购买数量
	 */
     ...
     * 虚拟订单第三步，产生订单
	 * POST
	 * 传入：goods_id:煤炭ID，quantity:购买数量，buyer_phone：接收手机，buyer_msg:下单留言,pd_pay:是否使用预存款支付0否1是，password：支付密码
	 */
