...
INSERT INTO  `#__setting` (`name`, `value`) VALUES ('mobile_apk', 'http://www.shopnc.net/download/app/AndroidShopNC2014Moblie.apk');
INSERT INTO  `#__setting` (`name`, `value`) VALUES ('mobile_apk_version', '2.0');
INSERT INTO  `#__setting` (`name`, `value`) VALUES ('mobile_ios', 'http://itunes.apple.com/cn/app/verync-yi-dong-shang-cheng/id534873145?mt=8');
