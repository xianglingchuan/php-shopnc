...
//随心看
$lang['microshop_goods_name'] = '煤炭名称';
$lang['microshop_goods_image'] = '煤炭图片';
...
$lang['microshop_goods_tip2'] = '点亮推荐列的符号，该煤炭将推荐到微商城首页';
...
$lang['microshop_goods_class_tip4'] = '点击二级分类后的"绑定分类"按钮可以绑定微商城和商城系统的分类，绑定后推荐的随心看煤炭将自动匹配分类';
$lang['microshop_goods_class_tip5'] = '点击二级分类后的"设为默认"按钮可以设定微商城的默认分类，随心看发布的商城中未绑定分类都将使用默认分类';
$lang['microshop_goods_class_binding_tip1'] = '选择下方的商城分类后单击完成绑定，绑定后推荐的随心看煤炭将自动匹配分类';
...
$lang['microshop_personal_tip2'] = '点亮推荐列的符号，该煤炭将推荐到微商城首页';

//煤企
$lang['microshop_store_add_confirm'] = '确认添加该煤企到煤企街?';
$lang['microshop_store_goods_count'] = '煤炭数';
$lang['microshop_store_credit'] = '卖家信用';
$lang['microshop_store_praise_rate'] = '好评率';
$lang['microshop_store_add'] = '已添加';
$lang['microshop_store_tip1'] = '通过修改排序数字可以控制前台煤企街的显示顺序，数字越小越靠前';
$lang['microshop_store_tip2'] = '点亮推荐列的符号，该煤企将推荐到微商城首页，首页最多显示15个推荐煤企';
$lang['microshop_store_add_tip1'] = '点击"添加"按钮将商城煤企添加到微商城的煤企街';
...
$lang['microshop_adv_type_store_list'] = '煤企列表页幻灯';
...
$lang['microshop_adv_image_explain'] = '首页广告图片推荐尺寸700px*280px，煤企列表页广告图片推荐尺寸1000px*250px';
