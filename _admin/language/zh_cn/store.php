...
$lang['user_open_store']   = '该用户已开通煤企';
$lang['user_no_exist']     = '您输入的用户名不存在';
$lang['pwd_fail']          = '您输入的密码不正确';
$lang['please_input_store_user_name_p'] = '请输入店主姓名';
$lang['please_input_store_name_p']      = '请输入煤企名称';
$lang['please_input_store_level']       = '请填写煤企等级';
$lang['back_store_list']       = '返回煤企列表';
$lang['countinue_add_store']   = '继续新增煤企';
$lang['store_name_exists']		= '该煤企名称已经存在，请您更换一个名称';
$lang['store_no_exist']        = '该煤企不存在。';
$lang['store_no_meet']         = '煤企不符合要求';
$lang['please_sel_store']  = '请选择要操作的煤企!';
$lang['address_no_null']       = '地区不能为空';
$lang['please_sel_edit_store'] = '请选择要编辑的煤企';
$lang['please_sel_edit_store'] = '请选择要编辑的内容!';

$lang['store']           = '煤企';
$lang['store_help1']     = '如果当前时间超过煤企有效期或煤企处于关闭状态，前台将不能继续浏览该煤企，但是店主仍然可以编辑该煤企';
$lang['store_help2']     = '被推荐煤企，将在前台的煤企推荐等相关位置展示，处于关闭中的煤企，不可推荐';
$lang['store_audit_help1']= '开店申请可批量通过审核';
$lang['store_grade_help1']=	'当管理员删除升级申请后，店主可继续申请煤企升级';
...
$lang['entity_store_certification']    = '实体煤企认证';
$lang['entity_store_certification_del']= '确定要删除煤企认证文件么？';
$lang['certification_del_success']	   = '认证文件删除成功';
$lang['certification_del_fail']	       = '认证文件删除失败';
$lang['recommended']                   = '推荐';
$lang['recommended_tips']              = '煤企关闭时不可推荐';
$lang['reset']                         = '重置';
$lang['please_input_store_name']       = '请输入煤企名称';
$lang['please_input_address']       = '请选择地区';
$lang['view_owner_certification_file'] = '查看实名认证文件';
$lang['view_entity_store_certification_file'] = '查看实体煤企认证文件';
$lang['store_user']               = '店主';
$lang['operation']                = '操作';
$lang['editable']                 = '可编辑';
$lang['are_you_sure_del_store']   = '您确定要删除煤企的所有信息（包括煤炭、订单等）吗？';
...
$lang['suffix']                  = '二级域名后缀';
$lang['demo']                    = '如煤企的二级域名是"test.shopnc.net", 则要填写"shopnc.net"';
