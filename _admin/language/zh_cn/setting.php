...
$lang['default_product_pic']   = '默认煤炭图片';
$lang['default_store_logo']    = '默认煤企标志';
...
$lang['image_dir_type_0']	= '按照文件名存放 (例:/煤企id/图片)';
$lang['image_dir_type_1']	= '按照年份存放 (例:/煤企id/年/图片)';
$lang['image_dir_type_2']	= '按照年月存放 (例:/煤企id/年/月/图片)';
$lang['image_dir_type_3']	= '按照年月日存放 (例:/煤企id/年/月/日/图片)';
$lang['image_width']	= '宽';
$lang['image_height']	= '高';
...
$lang['allowed_visitors_consult_notice']    = '允许游客在煤炭的详细展示页面，对当前煤炭进行咨询';
$lang['promotion_allow'] = '煤炭促销';
$lang['promotion_notice'] = '启用煤炭促销功能后，商家可以通过限时打折、满即送、优惠套装和推荐展位活动，对煤企煤炭进行促销';
...
$lang['points_isuse_notice'] = '积分系统启用后，可设置会员的注册、登录、购买煤炭送一定的积分';
$lang['voucher_allow'] = '代金券';
$lang['voucher_allow_notice'] = '代金券功能、积分功能、积分中心启用后，商家可以申请代金券活动；会员积分达到要求时可以在积分中心兑换代金券；<br>拥有代金券的会员可在代金券所属煤企内购买煤炭时，选择使用而得到优惠';
$lang['groupbuy_allow'] = '团购';
$lang['groupbuy_isuse_notice']    = '团购功能启用后，商家通过活动发布团购煤炭，进行促销';
...
$lang['front_goodsqa']           = '煤炭咨询';
$lang['front_regist']            = '前台注册';
$lang['allow_open_store']        = '开店申请';
$lang['setting_store_creditrule']        = '煤企信用';
...
$lang['points_number_comments']    = '订单煤炭评论';
$lang['points_number_order']    = '购煤并付款';
...
$lang['share_notice'] 	= '开启站外分享功能并设置站外分享绑定的相应接口后，SNS分享煤企和煤炭信息功能中将可以使用站外分享信息功能';


$lang['seo_set_index'] 		= '首页';
$lang['seo_set_group'] 		= '团购';
$lang['seo_set_brand'] 		= '煤企';
$lang['seo_set_point'] 		= '积分中心';
$lang['seo_set_article'] 	= '文章';
$lang['seo_set_shop'] 		= '煤企';
$lang['seo_set_product'] 	= '煤炭';
$lang['seo_set_category'] 	= '煤炭分类';
...
$lang['seo_set_tips2'] 	= '名称 {name}，（应用范围：团购名称、煤炭名称、煤企名称、文章标题、分类名称）';
$lang['seo_set_tips3'] 	= '文章分类名称 {article_class}，（应用范围：文章分类页）';
$lang['seo_set_tips4'] 	= '煤企名称 {shopname}，（应用范围：煤企页）';
$lang['seo_set_tips5'] 	= '关键词 {key}，（应用范围：煤炭关键词、文章关键词、煤企关键词）';
$lang['seo_set_tips6'] 	= '简单描述 {description}，（应用范围：煤炭描述、文章摘要、煤企关键词）';
$lang['seo_set_tips7'] 	= '<a>提交保存后，需要到 工具 -> 清理缓存 清理SEO，新的SEO设置才会生效</a>';
$lang['seo_set_group_content'] 		= '团购内容';
$lang['seo_set_brand_list'] 		= '某一煤企煤炭列表';
$lang['seo_set_point_content'] 		= '积分中心煤炭内容';
