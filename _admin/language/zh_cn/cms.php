...
$lang['cms_index_module_goods_explain'] = '请输以准确的煤炭网址以确保正确添加煤炭';
$lang['cms_index_module_goods_input_url'] = '输入煤炭地址';
$lang['cms_index_module_brand_selected'] = '已选择的煤企';
$lang['cms_index_module_brand_list'] = '煤企列表';
$lang['cms_index_module_brand_explain'] = '小提示：从煤企列表中最多可添加10个煤企，双击已选择的的煤企可删除；拖拽可排列顺序；保存后生效。';
$lang['cms_index_module_goods_class_explain'] = '从分类下拉菜单中选择该板块要推荐的分类，选择父级分类将包含字分类。';
$lang['cms_index_module_goods_class'] = '煤炭分类';
...
$lang['cms_index_module_goods_edit'] = '编辑煤炭';
$lang['cms_index_module_brand_edit'] = '编辑煤企';
$lang['cms_index_module_store_edit'] = '编辑煤企';
...
$lang['cms_special_image_and_goods'] = '选择插入图片或煤炭';
$lang['cms_special_image_explain1'] = '可选择本地图片上传，并添加链接后插入到主体内容的编辑器。链接形式可以为单图单链接，单图多重热点链接等模式。而煤炭则可通过输入煤炭网址形式直接插入到编辑器中。';
...
$lang['cms_special_goods_explain1'] = '请输入准确的煤炭网址以确保正确添加煤炭';
$lang['cms_special_goods_url'] = '输入煤炭地址';
$lang['cms_special_list_tip1'] = '专题可以支持煤炭列表、图片链接、图片热点三种内置方式，也可以自行编写HTML代码';
