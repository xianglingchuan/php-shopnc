...
$lang['bundling_goods_sum']			= '每个组合加入煤炭数量';
$lang['bundling_price_prompt']		= '购买单位为月(30天)，购买后卖家可以在所购买周期内发布优惠套装活动。';
$lang['bundling_sum_prompt']		= '允许煤企发布优惠套装的最大数量，0为没有限制。';
$lang['bundling_goods_sum_prompt']	= '每个组合能加入煤炭的最大数量，不大于5的数字。';
...
$lang['bundling_quota_store_name']	= '煤企名称';
...
$lang['bundling_quota_prompts']				= '查看每个煤企的优惠套装活动信息，您可以取消某个活动。';

// 套餐列表
$lang['bundling_name']						= '活动名称';
$lang['bundling_price']						= '活动销售价格';
$lang['bundling_goods_count']				= '煤炭数量';
