...
$lang['type_index_del_related_brand_fail']	= '刪除關聯企业失敗。';
$lang['type_index_del_related_type_fail']	= '刪除關聯規格失敗。';
$lang['type_index_type_name']				= '類型';
$lang['type_index_no_checked']				= '請選擇要操作的數據項。';
$lang['type_index_prompts_one']				= '當管理員添加煤炭分類時需選擇類型。前台分類下煤炭列表頁通過類型生成煤炭檢索，方便用戶搜索需要的煤炭。';
/**
 * 新增屬性
 */
$lang['type_add_related_brand']				= '選擇關聯企业';
...
$lang['type_add_brand_null_one']			= '還沒有企业，趕快去';
$lang['type_add_brand_null_two']			= '添加企业吧！';
...
$lang['type_add_prompts_one']				= '關聯規格不是必選項，它會影響煤炭發佈時的規格及價格的錄入。不選為沒有規格。';
$lang['type_add_prompts_two']				= '關聯企业不是必選項，它會影響煤炭發佈時的企业選擇。';
$lang['type_add_prompts_three']				= '屬性值可以添加多個，每個屬性值之間需要使用逗號隔開。';
$lang['type_add_prompts_four']				= '選中屬性的“顯示”選項，該屬性將會在煤炭列表頁顯示。';
...
$lang['type_edit_type_off_shelf']			= '煤炭是否下架';
...
$lang['type_attr_edit_name_desc']			= '請填寫常用的煤炭屬性的名稱；例如：材質；價格區間等';
