...
//隨心看
$lang['microshop_goods_name'] = '煤炭名稱';
$lang['microshop_goods_image'] = '煤炭圖片';
...
$lang['microshop_goods_tip2'] = '點亮推薦列的符號，該煤炭將推薦到微商城首頁';
...
$lang['microshop_goods_class_tip4'] = '點擊二級分類後的"綁定分類"按鈕可以綁定微商城和商城系統的分類，綁定後推薦的隨心看煤炭將自動匹配分類';
$lang['microshop_goods_class_tip5'] = '點擊二級分類後的"設為預設"按鈕可以設定微商城的預設分類，隨心看發佈的商城中未綁定分類都將使用預設分類';
$lang['microshop_goods_class_binding_tip1'] = '選擇下方的商城分類後單擊完成綁定，綁定後推薦的隨心看煤炭將自動匹配分類';
...
$lang['microshop_personal_tip2'] = '點亮推薦列的符號，該煤炭將推薦到微商城首頁';

//店舖
$lang['microshop_store_add_confirm'] = '確認添加該店舖到店舖街?';
$lang['microshop_store_goods_count'] = '煤炭數';
