...
$lang['goods_class_index_class']				= '煤炭分類';
...
$lang['goods_class_index_help1']				= '當店主添加煤炭時可選擇煤炭分類，用戶可根據分類查詢煤炭列表';
$lang['goods_class_index_help2']				= '點擊分類名前“+”符號，顯示當前分類的下級分類';
$lang['goods_class_index_help3'] 				= '<a>對分類作任何更改後，都需要到 設置 -> 清理緩存 清理煤炭分類，新的設置才會生效</a>';
/**
 * 批量編輯
 */
...
$lang['goods_class_edit_prompts_one']	= '"類型"關係到煤炭發佈時煤炭規格的添加，沒有類型的煤炭分類的將不能添加規格。';
$lang['goods_class_edit_prompts_two']	= '預設勾選"關聯到子分類"將煤炭類型附加到子分類，如子分類不同於上級分類的類型，可以取消勾選並單獨對子分類的特定類型進行編輯選擇。';
...
$lang['goods_class_export_if_trans']	= '導出您的煤炭分類數據';
$lang['goods_class_export_trans_tip']	= '';
$lang['goods_class_export_export']		= '導出';
$lang['goods_class_export_help1']		= '導出內容為煤炭分類信息的.csv檔案';
/**
 * TAG index
 */
...
$lang['goods_class_tag_prompts_three']	= '導入/重置TAG功能可以根據煤炭分類重新更新TAG，TAG值預設為各級煤炭分類值。';
 ...
 * 刪除TAG
 */
$lang['goods_class_tag_del_confirm']= '你確定要刪除煤炭分類TAG嗎?';