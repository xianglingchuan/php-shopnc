...
$lang['inform_handle_type_unuse_message'] = '無效舉報--煤炭會正常銷售';
$lang['inform_handle_type_venom_message'] = '惡意舉報--該用戶的所有未處理舉報將被取消，用戶將被禁止舉報';
$lang['inform_handle_type_valid_message'] = '有效舉報--煤炭將被違規下架';
...
$lang['inform_handling'] = '該煤炭已經被舉報請等待處理';
...
$lang['deny_inform'] = '您已經被禁止舉報煤炭，如有疑問請聯繫平台管理員'; 
$lang['inform_help1']='舉報類型和舉報主題由管理員在後台設置，在煤炭信息頁會員可根據舉報主題舉報違規煤炭';
$lang['inform_help2']='點擊詳細，查看舉報內容';
$lang['inform_help3']='查看已處理舉報內容';
$lang['inform_help4']='可在同一舉報類型下添加多個舉報主題';
$lang['inform_help5']='會員可根據舉報主題，舉報違規煤炭';
