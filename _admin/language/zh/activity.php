 ...
 * 活動內容
 */
$lang['activity_detail_index_goods_name']	= '煤炭名稱';
...
$lang['activity_detail_index_tip1']	= '申請煤炭在沒有審核或者審核失敗的時候可以刪除';
$lang['activity_detail_index_tip2']	= '本頁申請煤炭的顯示規則是未審核先顯示，排序越小越靠前顯示';
$lang['activity_detail_index_tip3']	= '下架、違規下架煤炭或者所屬店舖已經關閉的煤炭將不會在活動頁面顯示，請慎重審核';

/**
 * 活動內容刪除
 */
$lang['activity_detail_del_choose_detail']	= '請選擇活動內容(比如煤炭或團購等)';