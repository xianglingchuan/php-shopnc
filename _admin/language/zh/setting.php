...
$lang['default_product_pic']   = '預設煤炭圖片';
...
$lang['allowed_visitors_consult_notice']    = '允許遊客在煤炭的詳細展示頁面，對當前煤炭進行諮詢';
$lang['open_pseudo_static']                 = '啟用偽靜態';
$lang['open_kefu'] = '啟用在綫客服';
$lang['open_kefu_yes'] = '是';
$lang['open_kefu_no'] = '否';
$lang['promotion_allow'] = '煤炭促銷';
$lang['promotion_notice'] = '啟用煤炭促銷功能後，賣家可以通過限時打折和滿即送活動，對店舖煤炭進行促銷';
...
$lang['points_isuse_notice'] = '積分系統啟用後，可設置會員的註冊、登錄、購買煤炭送一定的積分';
$lang['open_predeposit_isuse'] = '預存款';
$lang['open_predeposit_isuse_notice'] = '預存款啟用後，會員可以給自己帳戶充值進行交易，加強平台對資金的管理';
$lang['voucher_allow'] = '代金券';
$lang['voucher_allow_notice'] = '代金券功能、積分功能、金幣功能、積分中心啟用後，賣家可以申請代金券活動；會員積分達到要求時可以在積分中心兌換代金券；<br>擁有代金券的會員可在代金券所屬店舖內購買煤炭時，選擇使用而得到優惠';
$lang['groupbuy_allow'] = '團購';
$lang['groupbuy_isuse_notice']    = '團購功能啟用後，平台可以發佈團購活動，企业通過活動發佈團購煤炭，進行促銷';
...
$lang['user_info_clear']         = '會員信息清除，其擁有的店舖和煤炭也會被清除，您確定要清除嗎?';
...
$lang['upload_goods_image_size_tiny'] = '煤炭微圖尺寸';
$lang['upload_goods_image_size_tiny_tips'] = '設定生成煤炭微圖的尺寸，單位為像素。';
$lang['upload_goods_image_size_small'] = '煤炭小圖尺寸';
$lang['upload_goods_image_size_small_tips'] = '設定生成煤炭小圖的尺寸，單位為像素。';
$lang['upload_goods_image_size_medium'] = '煤炭中圖尺寸';
$lang['upload_goods_image_size_medium_tips'] = '設定生成煤炭中圖的尺寸，單位為像素。';
$lang['upload_goods_image_size_large'] = '煤炭大圖尺寸';
$lang['upload_goods_image_size_large_tips'] = '設定生成煤炭大圖的尺寸，單位為像素。';
...
$lang['ztc_isuse_notice']    = '直通車功能啟用後，店主用金幣來購買，申請的煤炭在列表中會靠前';
...
$lang['points_number_comments']    = '訂單煤炭評論';
...
$lang['share_notice'] 	= '開啟站外分享功能並設置站外分享綁定的相應介面後，SNS分享店舖和煤炭信息功能中將可以使用站外分享信息功能';


$lang['seo_set_index'] 		= '首頁';
$lang['seo_set_group'] 		= '團購';
$lang['seo_set_brand'] 		= '企业';
$lang['seo_set_coupon'] 	= '優惠券';
$lang['seo_set_point'] 		= '積分中心';
$lang['seo_set_article'] 	= '文章';
$lang['seo_set_shop'] 		= '店舖';
$lang['seo_set_product'] 	= '煤炭';
$lang['seo_set_category'] 	= '煤炭分類';
...
$lang['seo_set_tips2'] 	= '名稱 {name}，（應用範圍：團購名稱、煤炭名稱、企业名稱、優惠券名稱、文章標題、分類名稱）';
$lang['seo_set_tips3'] 	= '文章分類名稱 {article_class}，（應用範圍：文章分類頁）';
$lang['seo_set_tips4'] 	= '店舖名稱 {shopname}，（應用範圍：店舖頁）';
$lang['seo_set_tips5'] 	= '關鍵詞 {key}，（應用範圍：煤炭關鍵詞、文章關鍵詞、店舖關鍵詞）';
$lang['seo_set_tips6'] 	= '簡單描述 {description}，（應用範圍：煤炭描述、文章摘要、店舖關鍵詞）';
$lang['seo_set_tips7'] 	= '<a>提交保存後，需要到 設置 -> 清理緩存 清理SEO，新的SEO設置才會生效</a>';
$lang['seo_set_group_content'] 		= '團購內容';
$lang['seo_set_brand_list'] 		= '某一企业煤炭列表';
$lang['seo_set_coupon_content'] 	= '優惠券內容';
$lang['seo_set_point_content'] 		= '積分中心煤炭內容';
