...
$lang['seller_tpl']     = '企业消息模板';
$lang['seller_tpl_edit']     = '编辑企业消息模板';
...
$lang['promotion_notice'] = '启用煤炭促销功能后，企业可以通过限时打折、满即送、优惠套装和推荐展位活动，对店铺煤炭进行促销';
...
$lang['voucher_allow_notice'] = '代金券功能、积分功能、积分中心启用后，企业可以申请代金券活动；会员积分达到要求时可以在积分中心兑换代金券；<br>拥有代金券的会员可在代金券所属店铺内购买煤炭时，选择使用而得到优惠';
$lang['groupbuy_allow'] = '团购';
$lang['groupbuy_isuse_notice']    = '团购功能启用后，企业通过活动发布团购煤炭，进行促销';
...
$lang['site_phone_notice']                  = '企业中心右下侧显示，方便企业遇到问题时咨询，多个请用半角逗号 "," 隔开';
...
$lang['site_email_notice']                  = '企业中心右下侧显示，方便企业遇到问题时咨询';
...
$lang['share_notice'] 	= '开启站外分享功能并设置站外分享绑定的相应接口后，SNS分享店铺和煤炭信息功能中将可以使用站外分享信息功能';
...
$lang['seo_set_tips2'] 	= '名称 {name}，（应用范围：团购名称、煤炭名称、企业名称、文章标题、分类名称）';
$lang['seo_set_tips3'] 	= '文章分类名称 {article_class}，（应用范围：文章分类页）';
$lang['seo_set_tips4'] 	= '店铺名称 {shopname}，（应用范围：店铺页）';
$lang['seo_set_tips5'] 	= '关键词 {key}，（应用范围：煤炭关键词、文章关键词、店铺关键词）';
$lang['seo_set_tips6'] 	= '简单描述 {description}，（应用范围：煤炭描述、文章摘要、店铺关键词）';
