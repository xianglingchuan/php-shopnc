...
$lang['goods_class_index_class']				= '煤炭分类';
...
$lang['goods_class_index_help1']				= '当店主添加煤炭时可选择煤炭分类，用户可根据分类查询煤炭列表';
$lang['goods_class_index_help2']				= '点击分类名前“+”符号，显示当前分类的下级分类';
$lang['goods_class_index_help3'] 				= '<a>对分类作任何更改后，都需要到 设置 -> 清理缓存 清理煤炭分类，新的设置才会生效</a>';
/**
 * 批量编辑
 */
...
$lang['goods_class_edit_prompts_one']	= '"类型"关系到煤炭发布时煤炭规格的添加，没有类型的煤炭分类的将不能添加规格。';
$lang['goods_class_edit_prompts_two']	= '默认勾选"关联到子分类"将煤炭类型附加到子分类，如子分类不同于上级分类的类型，可以取消勾选并单独对子分类的特定类型进行编辑选择。';
...
$lang['goods_class_export_if_trans']	= '导出您的煤炭分类数据';
$lang['goods_class_export_trans_tip']	= '';
$lang['goods_class_export_export']		= '导出';
$lang['goods_class_export_help1']		= '导出内容为煤炭分类信息的.csv文件';
/**
 * TAG index
 */
...
$lang['goods_class_tag_prompts_three']	= '导入/重置TAG功能可以根据煤炭分类重新更新TAG，TAG值默认为各级煤炭分类值。';
 ...
 * 删除TAG
 */
$lang['goods_class_tag_del_confirm']= '你确定要删除煤炭分类TAG吗?';