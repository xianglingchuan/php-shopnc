...
$lang['spec_index_prompts_one']		= '规格将会对应到煤炭发布的规格，规格值由店铺自己添加。';
$lang['spec_index_prompts_two']		= '默认安装中会添加一个默认颜色规格，请不要删除，只有这个颜色规格才能在煤炭详细页显示为图片。';
/**
 * 新增规格
 */
...
$lang['spec_index_spec_name_desc']	= '请填写常用的煤炭规格的名称；例如：颜色；尺寸等。';
