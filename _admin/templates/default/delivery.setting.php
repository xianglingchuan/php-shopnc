...
<div class="page">
  ...
  <form id="setting_form" method="post" action="<?php echo urlAdmin('delivery', 'save_setting');?>">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="promotion_booth_price">三号线运输车辆监管平台是否开启<?php echo $lang['nc_colon'];?></label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td colspan="2">现在去设置三号线运输车辆监管平台使用的快递公司，<a onclick="window.parent.openItem('index,express,setting');" href="JavaScript:void(0);">快递公司</a></td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
