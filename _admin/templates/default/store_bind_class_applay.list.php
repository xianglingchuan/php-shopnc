...
<table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td><ul>
            <li>此处可以对企业新申请的经营类目进行 审核/删除 操作</li>
          </ul></td>
      </tr>
    </tbody>
  </table>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <?php } ?>
          <a href="javascript:if(confirm('<?php echo $v['state'] == '1' ? '该类目已经审核通过，删除它可能影响到企业的使用，' : null;?>确认删除吗？'))window.location = 'index.php?act=store&op=store_bind_class_applay_del&bid=<?php echo $v['bid'];?>&store_id=<?php echo $v['store_id'];?>';"><?php echo $lang['nc_del'];?></a>
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
