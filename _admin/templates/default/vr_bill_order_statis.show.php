  ...
  <div class="fixed-bar">
    <div class="item-title">
      <h3>虚拟订单结算</h3>
		...
		<li><a class="current" href="JavaScript:void(0);"><span><?php echo !empty($_GET['os_month']) ? $_GET['os_month'].'期' : null;?> 企业账单列表</span></a></li>
		</ul>
    </div>
  </div>
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <option <?php if ($_GET['bill_state'] == BILL_STATE_STORE_COFIRM) {?>selected<?php } ?> value="<?php echo BILL_STATE_STORE_COFIRM;?>">企业已确认</option>
    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li>账单处理流程为：系统出账 > 企业确认 > 平台审核 > 财务支付(完成结算) 4个环节，其中平台审核和财务支付需要平台介入，请予以关注</li>
          </ul></td>
      </tr>
    </tbody>
  </table>
