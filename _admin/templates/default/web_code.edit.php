            ...
            <div class="middle">
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="icon-shopping-cart"></i><?php echo '煤炭块';?></a>
...
<div id="brand_list_dialog" class="brand_list_dialog" style="display:none;">
  <form id="brand_list_form">
    ...
    <dd>
      <h4 class="dialog-handle-title"><?php echo '已选择企业';?></h4>
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          <th><label for="recommend_brand_name"><?php echo '企业名称';?></label></th>
