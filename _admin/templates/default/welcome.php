    ...
    <dl class="goods">
      ...
      <dd>
        <ul>
          ...
          <li class="w25pre none"><a href="<?php echo urlAdmin('goods','goods',array('type'=>'waitverify', 'search_verify' => 10));?>">煤炭审核<sub><em id="statistics_product_verify">0</em></sub></a></li>
