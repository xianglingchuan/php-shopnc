  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody id="datatable">
      ...
      <tr class="hover">
        ...
        <td class="align-center"><a href="index.php?act=stat_trade&op=sale&search_type=month&searchmonth_month=<?php echo intval($_GET['search_month']); ?>&searchmonth_year=<?php echo intval($_GET['search_year']); ?>&store_name=<?php echo $v['ob_store_name']; ?>&order_type=40">详细</a></td>
      </tr>
      <?php } ?>
      <?php }else { ?>
      <tr class="no_data">
