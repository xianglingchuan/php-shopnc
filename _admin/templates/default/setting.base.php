  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <!-- 企业中心logo -->
        <tr>
          <td colspan="2" class="required"><label for="seller_center_logo">企业中心Logo:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png">
          ...
          <td class="vatop tips"><span class="vatop rowform">企业中心LOGO，最佳显示尺寸为150*40像素，请根据背景色选择使用图片色彩</span></td>
        </tr>
        <!-- 企业中心logo -->
        <tr>
