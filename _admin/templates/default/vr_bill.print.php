...
<tr><td colspan="4" style="border-bottom:1px solid #ccc"><h3 style="font-size:20px Arial,Verdana,'宋体';line-height:60px"><?php echo C('site_name');?> - 虚拟订单企业结算单</h3></td></tr>
<tr>
...
<?php }?>
<tr><td>企业应收</td><td><?php echo $output['bill_info']['ob_result_totals'];?></td></tr>
