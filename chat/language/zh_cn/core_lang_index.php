...
$lang['please_check_your_system_chmod_goods'] = '煤炭类别缓存文件不能写入，请检查文件以及文件夹权限是否正确!';
...
$lang['please_check_your_system_chmod_goods_class']	= '分类煤炭列表缓存文件不能写入，请检查文件以及文件夹权限是否正确!';
