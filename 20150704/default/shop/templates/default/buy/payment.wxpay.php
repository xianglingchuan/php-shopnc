...
.pw-box-ft {
    background: url("<?php echo SHOP_SITE_URL?>/templates/default/images/payment/icon-red.png") no-repeat scroll 50px 8px #ff7674;
    height: 44px;
    padding: 8px 0 8px 125px;
}
.p-w-sidebar {
    background: url("<?php echo SHOP_SITE_URL?>/templates/default/images/payment/phone-bg.png") no-repeat scroll 50px 0 rgba(0, 0, 0, 0);
    float: left;
    height: 421px;
    margin-top: -20px;
    padding-left: 50px;
  ...
  <div class="ncc-title">
    ...
    <div class="ncc-receipt-info">
      <div class="ncc-receipt-info-title">
        <h3>
        订单提交成功，请您尽快付款。订单号：<?php echo $output['pay_info']['pay_sn'];?>
        应付金额：<strong><?php echo ncPriceFormat($output['pay_info']['api_pay_amount']);?></strong>元
        </h3>
      </div>
    </div>
    ...
    <div class="pay-weixin">
        ...
        <div class="p-w-bd">
            <div class="p-w-box">
                <div class="pw-box-hd">
                    <img width="298" src="<?php echo SHOP_SITE_URL?>/index.php?act=payment&op=qrcode&data=<?php echo urlencode($output['pay_url']);?>">
                </div>
                <div class="pw-box-ft">
                    <p>请使用微信扫一扫</p>
                    <p>扫描二维码支付</p>
