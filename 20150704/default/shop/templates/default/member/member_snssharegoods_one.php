...
.dialog-share .bottom .button { color: #FFF; background-color: #BE000E; height: 28px; width: 80px; border: solid 1px #B22D00; cursor: pointer;}
    ...
    <div class="share-set">
      <div class="share-widget"><?php echo $lang['sharebind_alsoshareto'];?>
        <ul class="s-app">
          ...
          <?php }?>
          <?php }?>
          <div class="tip"><span class="arrow"></span>点亮图标分享煤炭到热门社交网络去~<a target="_blank" href="index.php?act=member_sharemanage"><?php echo $lang['sharebind_alsosharesetting'];?></a></div>
          <?php }?>
        </ul>
      </div>
    ...
    <div class="share-content">
      ...
      <div class="share-goods">
        ...
        <dl class="goods-intro">
          ...
          <dd><?php if (in_array($output['goods_info']['goods_promotion_type'], array(1,2))) {?><span><?php echo $output['goods_info']['goods_promotion_type'] == 1 ? '团购' : '限时';?></span><?php }?><strong>￥<?php echo $output['goods_info']['goods_promotion_price']; ?></strong></dd>
        </dl>
      </div>
