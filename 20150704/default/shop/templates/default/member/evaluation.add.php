...
<div class="ncm-flow-layout">
  <div class="ncm-flow-container">
    ...
    <form id="evalform" method="post" action="index.php?act=member_evaluate&op=<?php echo $_GET['op'];?>&order_id=<?php echo $_GET['order_id'];?>">
      ...
      <div class="tabmenu">
        <ul class="tab">
          <li class="active"><a href="javascript:void(0);">对购买过的煤炭评价</a></li>
        </ul>
      </div>
      <table class="ncm-default-table deliver mb30">
        ...
        <tbody>
          ...
          <tr class="bd-line">
            <td valign="top" class="w40"><div class="pic-thumb"><a href="index.php?act=goods&goods_id=<?php echo $goods['goods_id']; ?>" target="_blank"><img src="<?php echo $goods['goods_image_url']; ?>"/></a></div></td>
            ...
            <td valign="top" class="tr"><textarea name="goods[<?php if ($_GET['op'] != 'add_vr') { echo $goods['rec_id'];} else { echo $goods['goods_id'];}?>][comment]" cols="150" style="width: 280px;"></textarea></td>
          </tr>
          <?php }?>
          <?php }?>
        </tbody>
