...
<div class="ncm-flow-layout">
    ...
    <div class="ncm-default-form">
      ...
      <form id="add_form" enctype="multipart/form-data" method="post" action="index.php?act=member_inform&op=inform_save">
        ...
        <div class="bottom">
          ...
          <p class="hint">请客观地向平台反映您所遇到的真实情况，以共同维护一个诚信和公平的购物环境。</p>
        </div>
      </form>
    </div>
  </div>
  <div class="ncm-flow-item">
    ...
    <div class="content">
      <div class="alert">
        <ul>
          <li> 1.请提供充分的证据以确保举报成功，请珍惜您的会员权利，帮助平台更好地管理网站；</li>
          <li> 2.被举报待处理的煤炭不能反复进行违规提交，处理下架后的煤炭不能再次举报，企业如重新上架后仍存在违规现象，可再次对该煤炭进行违规举报；</li>
          <li> 3.举报仅针对煤炭或企业本身，如需处理交易中产生的纠纷，请选择投诉；</li>
