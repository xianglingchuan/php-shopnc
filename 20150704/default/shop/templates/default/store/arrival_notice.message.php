...
.recommend dt em { color: #FFF; background-color: #BE000E; padding: 0 5px; position: absolute; z-index: 1; bottom: 0; left: 0;}
.recommend dd { line-height: 16px; height: 32px; overflow: hidden; margin-top: 8px;}
</style>
<div class="eject_con">
  <div class="arrival-tip"><i class="icon-ok-circle"></i><?php if ($_GET['type'] == 2) {?>煤炭预约成功,请关注煤炭上架时间。<?php } else {?>一旦煤炭在30日内到货，您将收到邮件或短信通知！<?php }?></div>
</div>
<?php if(!empty($output['goods_list'])){?>
<div class="recommend">
  <div class="title">你可能喜欢的煤炭</div>
  <ul>
