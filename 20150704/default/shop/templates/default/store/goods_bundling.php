  ...
  <div class="ncs-combo-container" <?php if ($current) {?>style="display:none;"<?php }?>>
    <div class="default-goods">
      ...
      <dl>
        ...
        <dd class="goods-price">平台价<?php echo $lang['nc_colon'].$lang['currency'].$output['goods_info']['goods_promotion_price'];?></dd>
      </dl>
    </div>
    ...
    <dl>
    <dt>推荐购买组合</dt>
    <dd>平台总价：<?php echo $lang['currency'];?><em nctype="gbcc_p"><?php echo $output['goods_info']['goods_promotion_price'];?></em></dd>
