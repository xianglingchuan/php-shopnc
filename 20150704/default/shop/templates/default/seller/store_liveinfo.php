...
<div class="alert alert-block mt10">
  <ul>
    <li>1. 如您需要使用“虚拟团购”活动功能，并具有线下实体商铺请根据下列表单内容进行认真填写。</li>
    <li>2. 设置后的线下商铺信息将显示于“虚拟团购”活动详情页面右侧煤企介绍处，但不会影响原有线上煤企信息。</li>
  ...
  <form id="add_form" action="index.php?act=store_live&op=store_live" method="post" >
    <dl>
      ...
      <dd>
        ...
        <span></span>
        <p class="hint">该设置将作为兑换码的一部分，用于区别不同煤企之间的兑换码，增加兑换码使用的安全性，只接受字母或数字，最多3个字符。</p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <span></span>
        <p class="hint">线下煤企名称仅供线下“虚拟团购”活动使用，不影响原有线上煤企名称，商铺名称长度最多可输入30个字符。未填写时将显示线上煤企名称。</p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <span></span>
        <p class="hint">线下煤企电话用于“虚拟团购”活动中，买家与企业进行联系沟通使用，请认真填写。未填写内容时将默认显示线上煤企所留企业电话号码。</p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <span></span>
        <p class="hint">如您的煤企具有线下实体商铺地址，请认证填写此选项，保存后将更新地图定位，以供买家上门选购或兑换时使用。</p>
    ...
    <dl>
      ...
      <dd>
        <textarea class="textarea w500 h50" name="live_store_bus"><?php echo $output['store']['live_store_bus'];?></textarea>
         <p class="hint">此选项用于填写线下煤企周边交通信息或换乘方式，留空将不显示。</p>
      </dd>
    </dl>
    <div class="bottom">
