...
<div class="alert mt15 mb5"><strong>操作提示：</strong>
  <ul>
    <li>1、选择煤企经营的煤炭分类，以读取平台绑定的煤炭分类-规格类型，如分类：“服装”；规格：“颜色”、“尺码”等；当煤炭分类具有“颜色”规格时，可选择色块加以标识。</li>
    <li>2、添加所属规格下的规格值，已有规格值可以删除，新增未保存的规格值可以移除；<font color="red">新增的规格值必须填写</font>，否则该行数据不会被更新或者保存。</li>
    <li>3、可通过排序0-255改变规格值显示顺序；在发布煤炭时勾选已绑定的煤炭规格，还可对规格值进行“别名”修改操作，但不会影响规格值默认名称的设定。</li>
  </ul>
</div>
<table class="search-form">
  <tr>
    <td class="w20">&nbsp;</td>
    <td class="w120"><strong>选择经营的煤炭分类</strong></td>
    <td>
        <span nctype="gc1">
