...
<?php } ?>
    ...
    <dl>
      ...
      <div class="goods-thumb"><img id="groupbuy_goods_image" src=""/></div>
          ...
          <div class="goods-price">平台价：￥<span nctype="groupbuy_goods_price"></span></div>
      </div>
      <a href="javascript:void(0);" id="btn_show_search_goods" class="ncsc-btn ncsc-btn-acidblue">选择煤炭</a>
      ...
      <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
          <table class="search-form">
              <tr>
                  ...
                  <td class="w70 tc">
                    ...
                    <td class="w10"></td>
                    <td>
                        <p class="hint">不输入名称直接搜索将显示店内所有普通煤炭，特殊煤炭不能参加。</p>
                    </td>
                </tr>
            </table>
        ...
        <p class="hint"><?php echo $lang['groupbuy_goods_explain'];?></br><span class="red">团购生效后该煤炭的所有规格SKU都将执行统一的团购价格</span></p>
        </dd>
    </dl>
...
<?php } ?>
            ...
            groupbuy_goods_id: {
                ...
                checkGroupbuyGoods: '该煤炭已经参加了同时段的活动'
            },
            groupbuy_price: {
                ...
                lessThanGoodsPrice: '<i class="icon-exclamation-sign"></i>团购价格必须小于煤炭价格',
