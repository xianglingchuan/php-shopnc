...
<?php } ?>
          ...
          <table class="search-form">
              <tr>
                  ...
                  <td class="w70 tc">
                    ...
                    <td class="w10"></td>
                    <td>
                        <p class="hint">不输入名称直接搜索将显示店内所有虚拟煤炭。</p>
                    </td>
                </tr>
            </table>
    ...
    <dl>
      ...
      <dd>
        ...
        <span></span>
        <p class="hint">每个买家ID可团购的最大数量，该数量不能大于虚拟煤炭本身的限购数量，不限数量请填"0"</p>
      </dd>
    </dl>
    <dl>
...
<?php } ?>
                lessThanVrExpireTime : '<i class="icon-exclamation-sign"></i>结束时间必须小于虚拟煤炭过期时间',
            ...
            upper_limit: {
                ...
                lessThanVrLimitNum : '虚拟团购活动的限购数量不能大于虚拟煤炭本身的限购数量'
            },
            groupbuy_image: {
