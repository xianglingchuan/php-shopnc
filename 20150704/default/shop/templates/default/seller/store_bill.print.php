...
<tr><td colspan="4" style="border-bottom:1px solid #ccc"><h3 style="font-size:20px;line-height:60px"><?php echo C('site_name');?> - 实物订单企业结算单</h3></td></tr>
<tr>
<td width="80px">企业</td><td colspan="3"><?php echo $output['bill_info']['ob_store_name'];?></td>
</tr>
...
<?php }?>
<tr><td>企业应收</td><td colspan="3"><?php echo $output['bill_info']['ob_result_totals'];?></td></tr>
<tr><td>结算明细</td><td colspan="3"></td></tr>
<tr><td colspan="4"><?php echo $output['bill_info']['ob_order_totals'];?> (订单金额) - <?php echo $output['bill_info']['ob_commis_totals'];?> (佣金金额) - <?php echo $output['bill_info']['ob_order_return_totals'];?> (退单金额) + <?php echo $output['bill_info']['ob_commis_return_totals'];?> (退还佣金) - <?php echo $output['bill_info']['ob_store_cost_totals'];?> (煤企促销费用)</td></tr>
</table>