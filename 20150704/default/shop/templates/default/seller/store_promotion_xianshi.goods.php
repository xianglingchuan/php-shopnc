...
<ul class="goods-list">
  ...
  <li>
    ...
    <a nctype="btn_add_xianshi_goods" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-img="<?php echo thumb($val, 240);?>" data-goods-price="<?php echo $val['goods_price'];?>" href="javascript:void(0);" class="ncsc-btn-mini">选择煤炭/修改折扣价</a> </li>
  <?php } ?>
</ul>
  ...
  <div class="selected-goods-info">
    ...
    <dl class="goods-info">
      ...
      <p id="dialog_add_xianshi_goods_error">
          <label for="dialog_xianshi_price" class="error" ><i class='icon-exclamation-sign'></i>折扣价格不能为空，且必须小于煤炭价格</label></p></dd>
