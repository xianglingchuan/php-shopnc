  ...
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        ...
        <dd>若您的煤企还未开通<br/>
          请通过“<a href="<?php echo urlShop('store_joinin', 'index');?>" target="_blank">查看入驻进度</a>”了解煤企开通的最新状况 </dd>
      </dl>
...
<div class="main mt30">
  ...
  <div class="joinin-index-step"><span class="step"><i class="a"></i>签署入驻协议</span><span class="arrow"></span><span class="step"><i class="b"></i>企业信息提交</span><span class="arrow"></span><span class="step"><i class="c"></i>平台审核资质</span><span class="arrow"></span><span class="step"><i class="d"></i>企业缴纳费用</span><span class="arrow"></span><span class="step"><i class="e"></i>煤企开通</span></div>
