CREATE TABLE `#__activity` (
  ...
  `activity_type` enum('1','2') DEFAULT NULL COMMENT '活动类型 1:煤炭 2:团购',
...
CREATE TABLE `#__activity_detail` (
  ...
  `item_id` int(11) NOT NULL COMMENT '煤炭或团购的编号',
  `item_name` varchar(255) NOT NULL COMMENT '煤炭或团购名称',
  `store_id` int(11) NOT NULL COMMENT '煤企编号',
  `store_name` varchar(255) NOT NULL COMMENT '煤企名称',
...
CREATE TABLE `#__album_class` (
  ...
  `store_id` int(10) unsigned NOT NULL COMMENT '所属煤企id',
...
CREATE TABLE `#__arrival_notice` (
  ...
  `goods_id` int(10) unsigned NOT NULL COMMENT '煤炭id',
  `goods_name` varchar(50) NOT NULL COMMENT '煤炭名称',
  ...
  PRIMARY KEY (`an_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤炭到货通知表';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭属性表';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭属性值表';

CREATE TABLE `#__brand` (
  `brand_id` mediumint(11) NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `brand_name` varchar(100) DEFAULT NULL COMMENT '企业名称',
  `brand_initial` varchar(1) NOT NULL COMMENT '企业首字母',
  ...
  `store_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '煤企ID',
  `brand_apply` tinyint(1) NOT NULL DEFAULT '1' COMMENT '企业申请，0为申请中，1为通过，默认为1，申请功能是会员使用，系统后台默认为1',
  `class_id` int(10) unsigned DEFAULT '0' COMMENT '所属分类id',
  `show_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '企业展示类型 0表示图片 1表示文字 ',
...
CREATE TABLE `#__cart` (
  ...
  `store_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '煤企id',
  `store_name` varchar(50) NOT NULL DEFAULT '' COMMENT '煤企名称',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭id',
  `goods_name` varchar(100) NOT NULL COMMENT '煤炭名称',
  `goods_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '煤炭价格',
  `goods_num` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT '购买煤炭数量',
  `goods_image` varchar(100) NOT NULL COMMENT '煤炭图片',
...
CREATE TABLE `#__complain` (
  ...
  `order_goods_id` int(10) unsigned DEFAULT '0' COMMENT '订单煤炭ID',
...
CREATE TABLE `#__consult` (
  ...
  `goods_id` int(11) unsigned DEFAULT '0' COMMENT '煤炭编号',
  `goods_name` varchar(100) NOT NULL COMMENT '煤炭名称',
  `member_id` int(11) NOT NULL DEFAULT '0' COMMENT '咨询发布者会员编号(0：游客)',
  `member_name` varchar(100) DEFAULT NULL COMMENT '会员名称',
  `store_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '煤企编号',
  `store_name` varchar(50) NOT NULL COMMENT '煤企名称',
...
CREATE TABLE `#__cron` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type` tinyint(3) unsigned DEFAULT NULL COMMENT '任务类型 1煤炭上架 2根据煤炭id更新煤炭促销价格 3优惠套装过期 4推荐展位过期 5团购开始更新煤炭促销价格 6团购过期 7限时折扣过期',
  `exeid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '关联任务的ID[如煤炭ID,会员ID]',
...
CREATE TABLE `#__daddress` (
  `address_id` mediumint(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '地址ID',
  `store_id` mediumint(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企ID',
...
CREATE TABLE `#__evaluate_goods` (
  ...
  `geval_ordergoodsid` int(11) NOT NULL COMMENT '订单煤炭表编号',
  `geval_goodsid` int(11) NOT NULL COMMENT '煤炭表编号',
  `geval_goodsname` varchar(100) NOT NULL COMMENT '煤炭名称',
  `geval_goodsprice` decimal(10,2) DEFAULT NULL COMMENT '煤炭价格',
  `geval_goodsimage` varchar(255) DEFAULT NULL COMMENT '煤炭图片',
  ...
  `geval_storeid` int(11) NOT NULL COMMENT '煤企编号',
  `geval_storename` varchar(100) NOT NULL COMMENT '煤企名称',
...
CREATE TABLE `#__evaluate_store` (
  ...
  `seval_storeid` int(11) unsigned NOT NULL COMMENT '煤企编号',
  `seval_storename` varchar(100) NOT NULL COMMENT '煤企名称',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企评分表';
...
CREATE TABLE `#__flowstat` (
  ...
  `store_id` int(11) unsigned NOT NULL COMMENT '煤企ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
  `goods_id` int(11) unsigned NOT NULL COMMENT '煤炭ID'
...
CREATE TABLE `#__goods` (
  `goods_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '煤炭id(SKU)',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '煤炭公共表id',
  `goods_name` varchar(50) NOT NULL COMMENT '煤炭名称（+规格名称）',
  `goods_jingle` varchar(150) NOT NULL COMMENT '煤炭广告词',
  `store_id` int(10) unsigned NOT NULL COMMENT '煤企id',
  `store_name` varchar(50) NOT NULL COMMENT '煤企名称',
  `gc_id` int(10) unsigned NOT NULL COMMENT '煤炭分类id',
  ...
  `brand_id` int(10) unsigned NOT NULL COMMENT '企业id',
  `goods_price` decimal(10,2) NOT NULL COMMENT '煤炭价格',
  `goods_promotion_price` decimal(10,2) NOT NULL COMMENT '煤炭促销价格',
  ...
  `goods_serial` varchar(50) NOT NULL COMMENT '企业编号',
  `goods_storage_alarm` tinyint(3) unsigned NOT NULL COMMENT '库存报警值',
  `goods_click` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭点击数量',
  ...
  `goods_spec` text NOT NULL COMMENT '煤炭规格序列化',
  `goods_storage` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭库存',
  `goods_image` varchar(100) NOT NULL DEFAULT '' COMMENT '煤炭主图',
  `goods_state` tinyint(3) unsigned NOT NULL COMMENT '煤炭状态 0下架，1正常，10违规（禁售）',
  `goods_verify` tinyint(3) unsigned NOT NULL COMMENT '煤炭审核 1通过，0未通过，10审核中',
  `goods_addtime` int(10) unsigned NOT NULL COMMENT '煤炭添加时间',
  `goods_edittime` int(10) unsigned NOT NULL COMMENT '煤炭编辑时间',
  ...
  `goods_commend` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭推荐 1是，0否 默认0',
  `goods_stcids` varchar(255) NOT NULL DEFAULT '' COMMENT '煤企分类id 首尾用,隔开',
  ...
  `is_virtual` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为虚拟煤炭 1是，0否',
  `virtual_indate` int(10) unsigned NOT NULL COMMENT '虚拟煤炭有效期',
  `virtual_limit` tinyint(3) unsigned NOT NULL COMMENT '虚拟煤炭购买上限',
  `virtual_invalid_refund` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '是否允许过期退款， 1是，0否',
  `is_fcode` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否为F码煤炭 1是，0否',
  `is_appoint` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否是预约煤炭 1是，0否',
  `is_presell` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否是预售煤炭 1是，0否',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭表' AUTO_INCREMENT=100000;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤炭与属性对应表';

CREATE TABLE `#__goods_browse` (
  `goods_id` int(11) NOT NULL COMMENT '煤炭ID',
  `member_id` int(11) NOT NULL COMMENT '会员ID',
  `browsetime` int(11) NOT NULL COMMENT '浏览时间',
  `gc_id` int(11) NOT NULL COMMENT '煤炭分类',
  `gc_id_1` int(11) NOT NULL COMMENT '煤炭一级分类',
  `gc_id_2` int(11) NOT NULL COMMENT '煤炭二级分类',
  `gc_id_3` int(11) NOT NULL COMMENT '煤炭三级分类',
  PRIMARY KEY (`goods_id`,`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤炭浏览历史表';
...
CREATE TABLE `#__goods_class` (
  ...
  `gc_virtual` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否允许发布虚拟煤炭，1是，0否',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭分类表';
...
CREATE TABLE `#__goods_class_staple` (
  ...
  `gc_id_1` int(10) unsigned NOT NULL COMMENT '一级分类id',
  `gc_id_2` int(10) unsigned NOT NULL COMMENT '二级煤炭分类',
  `gc_id_3` int(10) unsigned NOT NULL COMMENT '三级煤炭分类',
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `member_id` int(10) unsigned NOT NULL COMMENT '会员id',
  `counter` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '计数器',
  PRIMARY KEY (`staple_id`),
  KEY `store_id` (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企常用分类表';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭分类TAG表';

CREATE TABLE `#__goods_combo` (
  `combo_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '推荐组合id ',
  `goods_id` int(10) unsigned NOT NULL COMMENT '主煤炭id',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '主煤炭公共id',
  `combo_goodsid` int(10) unsigned NOT NULL COMMENT '推荐组合煤炭id',
  PRIMARY KEY (`combo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤炭推荐组合表';

CREATE TABLE `#__goods_common` (
  `goods_commonid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '煤炭公共表id',
  `goods_name` varchar(50) NOT NULL COMMENT '煤炭名称',
  `goods_jingle` varchar(150) NOT NULL COMMENT '煤炭广告词',
  `gc_id` int(10) unsigned NOT NULL COMMENT '煤炭分类',
  `gc_id_1` int(10) unsigned NOT NULL COMMENT '一级分类id',
  `gc_id_2` int(10) unsigned NOT NULL COMMENT '二级分类id',
  `gc_id_3` int(10) unsigned NOT NULL COMMENT '三级分类id',
  `gc_name` varchar(200) NOT NULL COMMENT '煤炭分类',
  `store_id` int(10) unsigned NOT NULL COMMENT '煤企id',
  `store_name` varchar(50) NOT NULL COMMENT '煤企名称',
  `spec_name` varchar(255) NOT NULL COMMENT '规格名称',
  `spec_value` text NOT NULL COMMENT '规格值',
  `brand_id` int(10) unsigned NOT NULL COMMENT '企业id',
  `brand_name` varchar(100) NOT NULL COMMENT '企业名称',
  `type_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '类型id',
  `goods_image` varchar(100) NOT NULL COMMENT '煤炭主图',
  `goods_attr` text NOT NULL COMMENT '煤炭属性',
  `goods_body` text NOT NULL COMMENT '煤炭内容',
  `mobile_body` text NOT NULL COMMENT '手机端煤炭描述',
  `goods_state` tinyint(3) unsigned NOT NULL COMMENT '煤炭状态 0下架，1正常，10违规（禁售）',
  `goods_stateremark` varchar(255) DEFAULT NULL COMMENT '违规原因',
  `goods_verify` tinyint(3) unsigned NOT NULL COMMENT '煤炭审核 1通过，0未通过，10审核中',
  `goods_verifyremark` varchar(255) DEFAULT NULL COMMENT '审核失败原因',
  `goods_lock` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭锁定 0未锁，1已锁',
  `goods_addtime` int(10) unsigned NOT NULL COMMENT '煤炭添加时间',
  ...
  `goods_commend` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭推荐 1是，0否，默认为0',
  `goods_freight` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '运费 0为免运费',
  `goods_vat` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否开具增值税发票 1是，0否',
  `areaid_1` int(10) unsigned NOT NULL COMMENT '一级地区id',
  `areaid_2` int(10) unsigned NOT NULL COMMENT '二级地区id',
  ...
  `is_virtual` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为虚拟煤炭 1是，0否',
  `virtual_indate` int(10) unsigned DEFAULT NULL COMMENT '虚拟煤炭有效期',
  `virtual_limit` tinyint(3) unsigned DEFAULT NULL COMMENT '虚拟煤炭购买上限',
  `virtual_invalid_refund` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '是否允许过期退款， 1是，0否',
  `is_fcode` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为F码煤炭 1是，0否',
  `is_appoint` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否是预约煤炭 1是，0否',
  `appoint_satedate` int(10) unsigned NOT NULL COMMENT '预约煤炭出售时间',
  `is_presell` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否是预售煤炭 1是，0否',
  `presell_deliverdate` int(10) unsigned NOT NULL COMMENT '预售煤炭发货时间',
  `is_own_shop` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为平台自营',
  PRIMARY KEY (`goods_commonid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭公共内容表' AUTO_INCREMENT=100000 ;

CREATE TABLE `#__goods_fcode` (
  `fc_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'F码id',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '煤炭公共id',
  `fc_code` varchar(20) NOT NULL COMMENT 'F码',
  `fc_state` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '状态 0未使用，1已使用',
  PRIMARY KEY (`fc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤炭F码';

CREATE TABLE `#__goods_gift` (
  `gift_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '赠品id ',
  `goods_id` int(10) unsigned NOT NULL COMMENT '主煤炭id',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '主煤炭公共id',
  `gift_goodsid` int(10) unsigned NOT NULL COMMENT '赠品煤炭id ',
  `gift_goodsname` varchar(50) NOT NULL COMMENT '主煤炭名称',
  `gift_goodsimage` varchar(100) NOT NULL COMMENT '主煤炭图片',
  `gift_amount` tinyint(3) unsigned NOT NULL COMMENT '赠品数量',
  PRIMARY KEY (`gift_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤炭赠品表';

CREATE TABLE `#__goods_images` (
  `goods_image_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '煤炭图片id',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '煤炭公共内容id',
  `store_id` int(10) unsigned NOT NULL COMMENT '煤企id',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭图片';
...
CREATE TABLE `#__groupbuy` (
  ...
  `goods_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭ID',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '煤炭公共表ID',
  `goods_name` varchar(200) NOT NULL COMMENT '煤炭名称',
  `store_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企ID',
  `store_name` varchar(50) NOT NULL COMMENT '煤企名称',
  `goods_price` decimal(10,2) NOT NULL COMMENT '煤炭原价',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='团购煤炭表';
...
CREATE TABLE `#__groupbuy_quota` (
  ...
  `store_id` int(10) unsigned NOT NULL COMMENT '煤企编号',
...
CREATE TABLE `#__help` (
  ...
  `page_show` tinyint(1) unsigned DEFAULT '1' COMMENT '页面类型:1为煤企,2为会员,默认为1',
  PRIMARY KEY (`help_id`)
...
CREATE TABLE `#__inform` (
  ...
  `inform_goods_id` int(11) NOT NULL COMMENT '被举报的煤炭id',
  `inform_goods_name` varchar(100) NOT NULL COMMENT '被举报的煤炭名称',
  ...
  `inform_store_id` int(11) NOT NULL COMMENT '被举报煤炭的煤企id',
  ...
  `inform_goods_image` varchar(150) DEFAULT NULL COMMENT '煤炭图',
  `inform_store_name` varchar(100) DEFAULT NULL COMMENT '煤企名',
...
CREATE TABLE `#__navigation` (
  ...
  `nav_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '类别，0自定义导航，1煤炭分类，2文章导航，3活动导航，默认为0',
...
CREATE TABLE `#__offpay_area` (
  `store_id` int(8) unsigned NOT NULL COMMENT '企业ID',
...
CREATE TABLE `#__order` (
  ...
  `store_id` int(11) unsigned NOT NULL COMMENT '卖家煤企id',
  `store_name` varchar(50) NOT NULL COMMENT '卖家煤企名称',
  ...
  `goods_amount` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '煤炭总价格',
...
CREATE TABLE `#__order_bill` (
  `ob_no` int(11) NOT NULL AUTO_INCREMENT COMMENT '结算单编号(年月煤企ID)',
  ...
  `ob_store_cost_totals` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '煤企促销活动费用',
  ...
  `ob_store_id` int(11) NOT NULL COMMENT '煤企ID',
  `ob_store_name` varchar(50) DEFAULT NULL COMMENT '煤企名',
  PRIMARY KEY (`ob_no`)
...
CREATE TABLE `#__order_goods` (
  `rec_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '订单煤炭表索引id',
  `order_id` int(11) NOT NULL COMMENT '订单id',
  `goods_id` int(11) NOT NULL COMMENT '煤炭id',
  `goods_name` varchar(50) NOT NULL COMMENT '煤炭名称',
  `goods_price` decimal(10,2) NOT NULL COMMENT '煤炭价格',
  `goods_num` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT '煤炭数量',
  `goods_image` varchar(100) DEFAULT NULL COMMENT '煤炭图片',
  `goods_pay_price` decimal(10,2) unsigned NOT NULL COMMENT '煤炭实际成交价',
  `store_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企ID',
  `buyer_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '买家ID',
  `goods_type` enum('1','2','3','4','5') NOT NULL DEFAULT '1' COMMENT '1默认2团购煤炭3限时折扣煤炭4组合套装5赠品',
  ...
  `gc_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭最底级分类ID',
  PRIMARY KEY (`rec_id`),
  KEY `order_id` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单煤炭表';
...
CREATE TABLE `#__order_statis` (
  ...
  `os_store_cost_totals` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '煤企促销活动费用',
...
CREATE TABLE `#__points_goods` (
  ...
  `pgoods_view` int(11) NOT NULL DEFAULT '0' COMMENT '积分煤炭浏览次数',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='兑换订单煤炭表';

CREATE TABLE `#__p_booth_goods` (
  `booth_goods_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '套餐煤炭id',
  `store_id` int(10) unsigned NOT NULL COMMENT '煤企id',
  `goods_id` int(10) unsigned NOT NULL COMMENT '煤炭id',
  `gc_id` int(10) unsigned NOT NULL COMMENT '煤炭分类id',
  `booth_state` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '套餐状态 1开启 0关闭 默认1',
  PRIMARY KEY (`booth_goods_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='展位煤炭表';
...
CREATE TABLE `#__p_bundling` (
  ...
  `store_id` int(11) NOT NULL COMMENT '煤企名称',
  `store_name` varchar(50) NOT NULL COMMENT '煤企名称',
...
CREATE TABLE `#__p_bundling_goods` (
  `bl_goods_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '组合煤炭id',
  `bl_id` int(11) NOT NULL COMMENT '组合id',
  `goods_id` int(10) unsigned NOT NULL COMMENT '煤炭id',
  `goods_name` varchar(50) NOT NULL COMMENT '煤炭名称',
  `goods_image` varchar(100) NOT NULL COMMENT '煤炭图片',
  `bl_goods_price` decimal(10,2) NOT NULL COMMENT '煤炭价格',
  `bl_appoint` tinyint(3) unsigned NOT NULL COMMENT '指定煤炭 1是，0否',
  PRIMARY KEY (`bl_goods_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='组合销售活动煤炭表';

CREATE TABLE `#__p_bundling_quota` (
  `bl_quota_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '套餐ID',
  `store_id` int(11) NOT NULL COMMENT '煤企id',
  `store_name` varchar(50) NOT NULL COMMENT '煤企名称',
  `member_id` int(11) NOT NULL COMMENT '会员id',
  `member_name` varchar(50) NOT NULL COMMENT '会员名称',
...
CREATE TABLE `#__p_mansong_rule` (
  ...
  `goods_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭编号',
  PRIMARY KEY (`rule_id`)
...
CREATE TABLE `#__p_xianshi_goods` (
  `xianshi_goods_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '限时折扣煤炭表',
  `xianshi_id` int(10) unsigned NOT NULL COMMENT '限时活动编号',
  `xianshi_name` varchar(50) NOT NULL COMMENT '活动名称',
  `xianshi_title` varchar(10) DEFAULT NULL COMMENT '活动标题',
  `xianshi_explain` varchar(50) DEFAULT NULL COMMENT '活动说明',
  `goods_id` int(10) unsigned NOT NULL COMMENT '煤炭编号',
  `store_id` int(10) unsigned NOT NULL COMMENT '煤企编号',
  `goods_name` varchar(100) NOT NULL COMMENT '煤炭名称',
  `goods_price` decimal(10,2) NOT NULL COMMENT '煤企价格',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='限时折扣煤炭表';
...
CREATE TABLE `#__refund_return` (
  ...
  `store_id` int(10) unsigned NOT NULL COMMENT '煤企ID',
  `store_name` varchar(20) NOT NULL COMMENT '煤企名称',
  `buyer_id` int(10) unsigned NOT NULL COMMENT '买家ID',
  `buyer_name` varchar(50) NOT NULL COMMENT '买家会员名',
  `goods_id` int(10) unsigned NOT NULL COMMENT '煤炭ID,全部退款是0',
  `order_goods_id` int(10) unsigned DEFAULT '0' COMMENT '订单煤炭ID,全部退款是0',
  `goods_name` varchar(50) NOT NULL COMMENT '煤炭名称',
  `goods_num` int(10) unsigned DEFAULT '1' COMMENT '煤炭数量',
  `refund_amount` decimal(10,2) DEFAULT '0.00' COMMENT '退款金额',
  `goods_image` varchar(100) DEFAULT NULL COMMENT '煤炭图片',
  `order_goods_type` tinyint(1) unsigned DEFAULT '1' COMMENT '订单煤炭类型:1默认2团购煤炭3限时折扣煤炭4组合套装',
...
CREATE TABLE `#__seller_log` (
  ...
  `log_store_id` int(10) unsigned NOT NULL COMMENT '煤企编号',
...
CREATE TABLE `#__sns_albumpic` (
  ...
  `member_id` int(10) unsigned NOT NULL COMMENT '所属煤企id',
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
...
CREATE TABLE `#__sns_comment` (
  ...
  `comment_originaltype` tinyint(1) NOT NULL DEFAULT '0' COMMENT '原帖类型 0表示动态信息 1表示分享煤炭 默认为0',
...
CREATE TABLE `#__sns_goods` (
  `snsgoods_goodsid` int(11) NOT NULL COMMENT '煤炭ID',
  `snsgoods_goodsname` varchar(100) NOT NULL COMMENT '煤炭名称',
  `snsgoods_goodsimage` varchar(100) DEFAULT NULL COMMENT '煤炭图片',
  `snsgoods_goodsprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '煤炭价格',
  `snsgoods_storeid` int(11) NOT NULL COMMENT '煤企ID',
  `snsgoods_storename` varchar(100) NOT NULL COMMENT '煤企名称',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='SNS煤炭表';
...
CREATE TABLE `#__sns_sharegoods` (
  ...
  `share_goodsid` int(11) NOT NULL COMMENT '煤炭ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='共享煤炭表';

CREATE TABLE `#__sns_sharestore` (
  `share_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `share_storeid` int(11) NOT NULL COMMENT '煤企编号',
  `share_storename` varchar(100) NOT NULL COMMENT '煤企名称',
  `share_memberid` int(11) NOT NULL COMMENT '所属会员ID',
  ...
  `share_privacy` tinyint(1) NOT NULL DEFAULT '0' COMMENT '隐私可见度 0所有人可见 1好友可见 2仅自己可见',
  PRIMARY KEY (`share_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='共享煤企表';
...
CREATE TABLE `#__spec` (
  ...
  PRIMARY KEY (`sp_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭规格表';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭规格值表';
...
CREATE TABLE `#__stat_member` (
  ...
  `statm_goodsnum` int(11) NOT NULL DEFAULT '0' COMMENT '下单煤炭件数',
...
CREATE TABLE `#__stat_order` (
  ...
  `store_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企ID',
  `store_name` varchar(50) NOT NULL COMMENT '卖家煤企名称',
  `grade_id` int(11) NOT NULL COMMENT '煤企等级',
  `sc_id` int(11) NOT NULL COMMENT '煤企分类',
  `buyer_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '买家ID',
  `buyer_name` varchar(50) NOT NULL COMMENT '买家姓名',
...
CREATE TABLE `#__stat_ordergoods` (
  `rec_id` int(11) NOT NULL COMMENT '订单煤炭表索引id',
  ...
  `buyer_name` varchar(50) NOT NULL COMMENT '买家姓名',
  `goods_id` int(11) NOT NULL COMMENT '煤炭id',
  `goods_name` varchar(50) NOT NULL COMMENT '煤炭名称(+规格)',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '煤炭公共表id',
  `goods_commonname` varchar(50) NOT NULL COMMENT '煤炭公共表中煤炭名称',
  `gc_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '煤炭最底级分类ID',
  ...
  `goods_image` varchar(100) DEFAULT NULL COMMENT '煤炭图片',
  `goods_pay_price` decimal(10,2) unsigned NOT NULL COMMENT '煤炭实际成交价',
  `goods_type` enum('1','2','3','4','5') NOT NULL DEFAULT '1' COMMENT '1默认2团购煤炭3限时折扣煤炭4优惠套装5赠品',
  `promotions_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '促销活动ID（团购ID/限时折扣ID/优惠套装ID）与goods_type搭配使用',
  `commis_rate` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '佣金比例',
  UNIQUE KEY `rec_id` (`rec_id`),
  KEY `order_id` (`order_id`),
  KEY `order_add_time` (`order_add_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='统计功能订单煤炭缓存表';

CREATE TABLE `#__store` (
  `store_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '煤企索引id',
  `store_name` varchar(50) NOT NULL COMMENT '煤企名称',
  `grade_id` int(11) NOT NULL COMMENT '煤企等级',
  `member_id` int(11) NOT NULL COMMENT '会员id',
  `member_name` varchar(50) NOT NULL COMMENT '会员名称',
  ...
  `sc_id` int(11) NOT NULL COMMENT '煤企分类',
  `store_company_name` varchar(50) DEFAULT NULL COMMENT '煤企公司名称',
  `province_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '煤企所在省份ID',
  ...
  `store_state` tinyint(1) NOT NULL DEFAULT '2' COMMENT '煤企状态，0关闭，1开启，2审核中',
  `store_close_info` varchar(255) DEFAULT NULL COMMENT '煤企关闭原因',
  `store_sort` int(11) NOT NULL DEFAULT '0' COMMENT '煤企排序',
  `store_time` varchar(10) NOT NULL COMMENT '煤企时间',
  `store_end_time` varchar(10) DEFAULT NULL COMMENT '煤企关闭时间',
  `store_label` varchar(255) DEFAULT NULL COMMENT '煤企logo',
  `store_banner` varchar(255) DEFAULT NULL COMMENT '煤企横幅',
  `store_avatar` varchar(150) DEFAULT NULL COMMENT '煤企头像',
  `store_keywords` varchar(255) NOT NULL DEFAULT '' COMMENT '煤企seo关键字',
  `store_description` varchar(255) NOT NULL DEFAULT '' COMMENT '煤企seo描述',
  `store_qq` varchar(50) DEFAULT NULL COMMENT 'QQ',
  `store_ww` varchar(50) DEFAULT NULL COMMENT '阿里旺旺',
  `store_phone` varchar(20) DEFAULT NULL COMMENT '企业电话',
  `store_zy` text COMMENT '主营煤炭',
  `store_domain` varchar(50) DEFAULT NULL COMMENT '煤企二级域名',
  ...
  `store_theme` varchar(50) NOT NULL DEFAULT 'default' COMMENT '煤企当前主题',
  `store_credit` int(10) NOT NULL DEFAULT '0' COMMENT '煤企信用',
  ...
  `store_collect` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企收藏数量',
  `store_slide` text COMMENT '煤企幻灯片',
  `store_slide_url` text COMMENT '煤企幻灯片链接',
  `store_stamp` varchar(200) DEFAULT NULL COMMENT '煤企印章',
  `store_printdesc` varchar(500) DEFAULT NULL COMMENT '打印订单页面下方说明文字',
  `store_sales` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企销量',
  ...
  `store_decoration_switch` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企装修开关(0-关闭 装修编号-开启)',
  `store_decoration_only` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '开启煤企装修时，仅显示煤企装修(1-是 0-否',
  `store_decoration_image_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企装修相册图片数量',
  `live_store_name` varchar(255) DEFAULT NULL COMMENT '商铺名称',
  `live_store_address` varchar(255) DEFAULT NULL COMMENT '企业地址',
  `live_store_tel` varchar(255) DEFAULT NULL COMMENT '商铺电话',
  `live_store_bus` varchar(255) DEFAULT NULL COMMENT '公交线路',
  `is_own_shop` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否自营煤企 1是 0否',
  `bind_all_gc` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '自营店是否绑定全部分类 0否1是',
  `store_vrcode_prefix` char(3) DEFAULT NULL COMMENT '企业兑换码前缀',
  PRIMARY KEY (`store_id`),
  KEY `store_name` (`store_name`),
  KEY `sc_id` (`sc_id`),
  KEY `store_state` (`store_state`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企数据表';

CREATE TABLE `#__store_bind_class` (
  `bid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `store_id` int(11) unsigned DEFAULT '0' COMMENT '煤企ID',
  ...
  `state` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '状态0审核中1已审核 2平台自营煤企',
  PRIMARY KEY (`bid`),
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企可发布煤炭类目表';
...
CREATE TABLE `#__store_class` (
  ...
  PRIMARY KEY (`sc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企分类表';

CREATE TABLE `#__store_cost` (
  `cost_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '费用编号',
  `cost_store_id` int(10) unsigned NOT NULL COMMENT '煤企编号',
  ...
  PRIMARY KEY (`cost_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企费用表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企装修表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企装修相册表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企装修块表';

CREATE TABLE `#__store_extend` (
  `store_id` mediumint(8) unsigned NOT NULL COMMENT '煤企ID',
  `express` text COMMENT '快递公司ID的组合',
  `pricerange` text COMMENT '煤企统计设置的煤炭价格区间',
  `orderpricerange` text COMMENT '煤企统计设置的订单价格区间',
  PRIMARY KEY (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企信息扩展表';

CREATE TABLE `#__store_goods_class` (
  `stc_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `stc_name` varchar(50) NOT NULL COMMENT '煤企煤炭分类名称',
  `stc_parent_id` int(11) NOT NULL COMMENT '父级id',
  `stc_state` tinyint(1) NOT NULL DEFAULT '0' COMMENT '煤企煤炭分类状态',
  `store_id` int(11) NOT NULL DEFAULT '0' COMMENT '煤企id',
  `stc_sort` int(11) NOT NULL DEFAULT '0' COMMENT '煤炭分类排序',
  PRIMARY KEY (`stc_id`),
  KEY `stc_parent_id` (`stc_parent_id`,`stc_sort`),
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企煤炭分类表';
...
CREATE TABLE `#__store_grade` (
  ...
  `sg_goods_limit` mediumint(10) unsigned NOT NULL DEFAULT '0' COMMENT '允许发布的煤炭数量',
  ...
  `sg_template_number` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '选择煤企模板套数',
  ...
  PRIMARY KEY (`sg_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企等级表';
...
CREATE TABLE `#__store_joinin` (
  ...
  `store_name` varchar(50) DEFAULT NULL COMMENT '煤企名称',
  `store_class_ids` varchar(1000) DEFAULT NULL COMMENT '煤企分类编号集合',
  `store_class_names` varchar(1000) DEFAULT NULL COMMENT '煤企分类名称集合',
  ...
  `sg_name` varchar(50) DEFAULT NULL COMMENT '煤企等级名称',
  `sg_id` int(10) unsigned DEFAULT NULL COMMENT '煤企等级编号',
  `sg_info` varchar(200) DEFAULT NULL COMMENT '煤企等级下的收费等信息',
  `sc_name` varchar(50) DEFAULT NULL COMMENT '煤企分类名称',
  `sc_id` int(10) unsigned DEFAULT NULL COMMENT '煤企分类编号',
  `sc_bail` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '煤企分类保证金',
  ...
  PRIMARY KEY (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企入住表';

CREATE TABLE `#__store_msg` (
  `sm_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '煤企消息id',
  ...
  PRIMARY KEY (`sm_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企消息表';

CREATE TABLE `#__store_msg_read` (
  `sm_id` int(11) NOT NULL COMMENT '煤企消息id',
  `seller_id` int(11) NOT NULL COMMENT '卖家id',
  `read_time` int(11) NOT NULL COMMENT '阅读时间',
  PRIMARY KEY (`sm_id`,`seller_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企消息阅读表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企消息接收设置';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='企业消息模板';
...
CREATE TABLE `#__store_navigation` (
  ...
  `sn_store_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '卖家煤企ID',
  ...
  `sn_url` varchar(255) DEFAULT NULL COMMENT '煤企导航的外链URL',
  `sn_new_open` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '煤企导航外链是否在新窗口打开：0不开新窗口1开新窗口，默认是0',
  PRIMARY KEY (`sn_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='卖家煤企导航信息表';
...
CREATE TABLE `#__store_reopen` (
  ...
  `re_grade_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '煤企等级ID',
  ...
  `re_store_name` varchar(50) DEFAULT NULL COMMENT '煤企名字',
  `re_store_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '煤企ID',
...
CREATE TABLE `#__store_sns_comment` (
  `scomm_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '煤企动态评论id',
  `strace_id` int(11) NOT NULL COMMENT '煤企动态id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企动态评论表';

CREATE TABLE `#__store_sns_setting` (
  `sauto_storeid` int(11) NOT NULL COMMENT '煤企id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企自动发布动态设置表';

CREATE TABLE `#__store_sns_tracelog` (
  `strace_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '煤企动态id',
  `strace_storeid` int(11) DEFAULT NULL COMMENT '煤企id',
  `strace_storename` varchar(100) DEFAULT NULL COMMENT '煤企名称',
  ...
  `strace_goodsdata` varchar(1000) DEFAULT NULL COMMENT '煤炭信息',
  `strace_state` tinyint(1) NOT NULL DEFAULT '1' COMMENT '动态状态 1正常，0屏蔽',
  PRIMARY KEY (`strace_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企动态表';
...
CREATE TABLE `#__store_watermark` (
  ...
  `store_id` int(11) DEFAULT NULL COMMENT '煤企id',
  PRIMARY KEY (`wm_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企水印图片表';

CREATE TABLE `#__store_waybill` (
  `store_waybill_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '煤企运单模板编号',
  `store_id` int(10) unsigned NOT NULL COMMENT '煤企编号',
  ...
  `store_waybill_data` varchar(2000) DEFAULT NULL COMMENT '煤企自定义设置',
  `is_default` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否默认模板',
  `store_waybill_left` int(11) NOT NULL DEFAULT '0' COMMENT '煤企运单左偏移',
  `store_waybill_top` int(11) NOT NULL DEFAULT '0' COMMENT '煤企运单上偏移',
  PRIMARY KEY (`store_waybill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤企运单模板表';
...
CREATE TABLE `#__type` (
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='煤炭类型表';

CREATE TABLE `#__type_brand` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `brand_id` int(10) unsigned NOT NULL COMMENT '企业id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤炭类型与企业对应表';

CREATE TABLE `#__type_spec` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `sp_id` int(10) unsigned NOT NULL COMMENT '规格id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='煤炭类型与规格对应表';
...
CREATE TABLE `#__upload` (
  ...
  `upload_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '文件类别，0为无，1为文章图片，默认为0，2为帮助内容图片，3为煤企幻灯片，4为系统文章图片，5为积分礼品切换图片，6为积分礼品内容图片',
...
CREATE TABLE `#__voucher` (
  ...
  `voucher_store_id` int(11) NOT NULL COMMENT '代金券的煤企id',
...
CREATE TABLE `#__voucher_quota` (
  ...
  `quota_storeid` int(11) NOT NULL COMMENT '煤企编号',
  `quota_storename` varchar(100) NOT NULL COMMENT '煤企名称',
...
CREATE TABLE `#__voucher_template` (
  ...
  `voucher_t_store_id` int(11) NOT NULL COMMENT '代金券模版的煤企id',
  `voucher_t_storename` varchar(100) DEFAULT NULL COMMENT '煤企名称',
  `voucher_t_sc_id` int(11) NOT NULL DEFAULT '0' COMMENT '所属煤企分类ID',
...
CREATE TABLE `#__vr_order` (
  ...
  `goods_image` varchar(100) DEFAULT NULL COMMENT '煤炭图片',
  `commis_rate` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '佣金比例',
  `gc_id` mediumint(9) DEFAULT '0' COMMENT '煤炭最底级分类ID',
...
CREATE TABLE `#__vr_order_bill` (
  `ob_no` int(11) NOT NULL COMMENT '结算单编号(年月煤企ID)',
  `ob_start_date` int(11) NOT NULL COMMENT '开始日期',
  `ob_end_date` int(11) NOT NULL COMMENT '结束日期',
  `ob_order_totals` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '订单金额',
  `ob_commis_totals` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '佣金金额',
...
CREATE TABLE `#__vr_refund` (
  ...
  `buyer_name` varchar(50) NOT NULL COMMENT '买家会员名',
  `goods_id` int(10) unsigned NOT NULL COMMENT '煤炭ID',
  `goods_num` int(10) unsigned DEFAULT '1' COMMENT '退款煤炭数量',
  `goods_name` varchar(50) NOT NULL COMMENT '煤炭名称',
  `goods_image` varchar(100) DEFAULT NULL COMMENT '煤炭图片',
...
CREATE TABLE `#__waybill` (
  ...
  `store_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '煤企编号(0-代表系统模板)',
...
(11, '首页焦点大图广告1', '位于首页焦点大图区', 0, 2, 1, 1920, 481, 100, 0, 0, '11.jpg'),
(12, '首页焦点大图广告2', '位于首页焦点大图区', 0, 2, 1, 1920, 481, 100, 0, 0, '12.jpg'),
(21, '首页焦点联动广告1', '位于首页焦点联动区', 0, 2, 1, 259, 180, 100, 0, 0, '21.jpg'),
(22, '首页焦点联动广告2', '位于首页焦点联动区', 0, 2, 1, 259, 180, 100, 0, 0, '22.jpg'),
(23, '首页焦点联动广告3', '位于首页焦点联动区', 0, 2, 1, 259, 180, 100, 0, 0, '23.jpg'),
(35, '积分列表页中部广告位', '积分列表页中部广告位', 0, 2, 1, 900, 368, 30, 0, 0, '04606336969591517.jpg'),
(37, '煤炭列表页左侧广告位', '煤炭列表页左侧广告位', 0, 1, 1, 206, 300, 100, 0, 0, '7a4832d109ee46fe7677c1d3c30e067f.gif');
...
(10, 2, '', 1, 255, '查看已购买煤炭', '查看已购买煤炭', 1389864697),
(11, 3, '', 1, 255, '如何管理煤企', '如何管理煤企', 1389864697),
(12, 3, '', 1, 255, '查看售出煤炭', '查看售出煤炭', 1389864697),
(13, 3, '', 1, 255, '如何发货', '如何发货', 1389864697),
(14, 3, '', 1, 255, '商城煤炭推荐', '商城煤炭推荐', 1389864697),
...
(20, 6, '', 1, 255, '煤炭发布', '煤炭发布', 1389864697),
...
(96, 1, '招商方向', '<p>\r\n    <strong>2014年开放平台招商方向</strong> \r\n</p>\r\n<p>\r\n  <br />\r\n</p>\r\n<h1>\r\n  1.&nbsp;&nbsp;&nbsp; 企业\r\n</h1>\r\n<p>\r\n <br />\r\n</p>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 国际国内知名企业<br />\r\n<p>\r\n    &nbsp; &nbsp; &nbsp; &nbsp;开放平台将一如既往的最大程度地维护卖家的企业利益，尊重企业传统和内涵，欢迎优质企业旗\r\n</p>\r\n<p>\r\n    <br />\r\n</p>\r\n<p>\r\n   舰店入驻，请参见《2014年开放平台重点招募企业》。\r\n</p>\r\n<h1>\r\n  <br />\r\n</h1>\r\n<h1>\r\n 2.&nbsp;&nbsp;&nbsp; 货品\r\n</h1>\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br />\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 能够满足用户群体优质、有特色的货品。<br />\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 根据类目结构细分的货品配置。类目规划详见《2014年开放平台类目一览表》。<br />\r\n<h1>\r\n    3.&nbsp;&nbsp; 垂直电商\r\n</h1>\r\n<p>\r\n <br />\r\n</p>\r\n<p>\r\n   &nbsp; &nbsp; &nbsp; 开放平台欢迎垂直类电商入驻。开放平台愿意和专业的垂直电商企业分享其优质用户群体，\r\n</p>\r\n<p>\r\n    <br />\r\n</p>\r\n<p>\r\n   并且欢迎垂直电商为用户提供该领域专业的货品及服务。\r\n</p>\r\n<p>\r\n    <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>', '', 1399284217, 1, 1),
(97, 2, '招商标准', '<p>\n  <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  本标准适用于除虚拟业务（包括但不限于旅游、酒店、票务、充值、彩票）外的平台开放平台所有卖家。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <b>第一章 入驻</b><b></b> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n   1.1&nbsp;&nbsp;&nbsp; 平台开放平台暂未授权任何机构进行代理招商服务，入驻申请流程及相关的收费说明均以平台开放平台官方招商页面为准。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    1.2 &nbsp;&nbsp; 平台开放平台有权根据包括但不限于企业需求、公司经营状况、服务水平等其他因素退回卖家申请。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   1.3 &nbsp;&nbsp; 平台开放平台有权在申请入驻及后续经营阶段要求卖家提供其他资质。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    1.4 &nbsp;&nbsp; 平台开放平台将结合各行业发展动态、国家相关规定及消费者购买需求，不定期更新招商标准。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 1.5 &nbsp;&nbsp; 卖家必须如实提供资料和信息：\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 1.5.1 请务必确保申请入驻及后续经营阶段提供的相关资质和信息的真实性、完整性、有效性（若卖家提供的相关资质为第三方提供，包括但不限于商标注册证、授权书\n等，请务必先行核实文件的真实有效完整性），一旦发现虚假资质或信息的，平台开放平台将不再与卖家进行合作并有权根据平台开放平台规则及与卖家签署的相关 协议之约定进行处理；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  1.5.2&nbsp; 卖家应如实提供其煤企运营的主体及相关信息，包括但不限于煤企实际经营主体、代理运营公司等信息；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  1.5.3&nbsp; 平台开放平台关于卖家信息和资料变更有相关规定的从其规定，但卖家如变更<span>1.5.2</span>项所列信息，应提前十日书面告知平台；如未提前告知平台，平台将根据平台开放平台规则进行处理。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   1.6&nbsp;&nbsp;&nbsp; 平台开放平台暂不接受个体工商户的入驻申请，卖家须为正式注册企业，亦暂时不接受非中国大陆注册企业的入驻申请。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 1.7&nbsp;&nbsp;&nbsp; 平台开放平台暂不接受未取得国家商标总局颁发的商标注册证或商标受理通知书的企业开店申请，亦不接受纯图形类商标的入驻申请。卖家提供商标受理通知书（<span>TM</span>状态商标）的，注册申请时间须满六个月。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <b>第二章 平台煤企类型及相关要求</b><b></b> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n  2.1&nbsp;&nbsp;&nbsp;&nbsp; 旗舰店，卖家以自有企业（商标为<span>R</span>或<span>TM</span>状态），或由权利人出具的在平台开放平台开设企业旗舰店的授权文件（授权文件中应明确排他性、不可撤销性），入驻平台开放平台开设的煤企。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  2.1.1&nbsp; 旗舰店，可以有以下几种情形：\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  经营一个自有企业（商标为<span>R</span>或<span>TM</span>状态）煤炭入驻平台开放平台的卖家旗舰店，（自有企业是指商标权利归卖家所有，自有企业的子企业可以放入旗舰店，主、子企业的商标权利人应为同一实际控制人）；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   经营已获得明确排他性授权的一个企业煤炭入驻平台开放平台的卖家旗舰店；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  卖场型企业（服务类商标）商标权人开设的旗舰店；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 2.1.2&nbsp; 开店主体必须是企业（商标）权利人或持有权利人出具的开设平台开放平台旗舰店排他性授权文件的被授权企业。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  2.2&nbsp;&nbsp;&nbsp;&nbsp; 专卖店，卖家持他人企业（商标为<span>R</span>或<span>TM</span>状态）授权文件在平台开放平台开设的煤企。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   2.2.1&nbsp; 专卖店类型：经营一个或多个授权企业煤炭（多个授权企业的商标权人应为同一实际控制人）但未获得旗舰店排他授权入驻平台开放平台的卖家专卖店；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 2.2.2 &nbsp; 企业（商标）权利人出具的授权文件不应有地域限制。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   2.3&nbsp;&nbsp;&nbsp;&nbsp; 专营店，经营平台开放平台相同一级经营类目下两个及以上他人或自有企业（商标为<span>R</span>或<span>TM</span>状态）煤炭的煤企。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    2.3.1&nbsp; 专营店，可以有以下几种情形：\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  相同一级类目下经营两个及以上他人企业煤炭入驻平台开放平台的卖家专营店；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 相同一级类目下既经营他人企业煤炭又经营自有企业煤炭入驻平台开放平台的卖家专营店。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    2.4 &nbsp; &nbsp; 各类型煤企命名详细说明，请见<span>《平台开放平台卖家煤企命名规则》。</span> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <b>第三章 平台申请入驻资质标准</b><b></b> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n   3.1&nbsp;&nbsp;&nbsp; 平台开放平台申请入驻资质标准详见<span>《平台开放平台招商资质标准细则》。</span> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n   <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <b>第四章 开店入驻限制</b><b></b> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n   4.1&nbsp;&nbsp;&nbsp; 企业入驻限制：\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   4.1.1 与平台平台已有的自有企业、频道、业务、类目等相同或相似名称的企业；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 4.1.2&nbsp; 包含行业名称或通用名称的企业；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 4.1.3&nbsp; 包含知名人士、地名的企业；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   4.1.4&nbsp; 与知名企业相同或近似的企业。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  4.2&nbsp;&nbsp;&nbsp;&nbsp; 经营类目限制，卖家开店所经营的类目应当符合平台开放平台的相关标准，详细请参考<span>《平台开放平台经营类目资费一览表》。</span> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n  4.3同一主体入驻的煤企限制：\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 4.3.1&nbsp; 单个煤企只可对应一种经营模式。各经营模式内容请参考与卖家签署的对应合同；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    4.3.2&nbsp; 同一主体开设若干煤企的，经营模式总计不得超过两种，且须在开展第二种经营模式时提前<span>10</span>日向平台进行书面申请；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  4.3.3&nbsp; 煤炭重合度：要求煤企间经营的企业及煤炭不得重复，<span>4.3.2</span>项下经过平台审批的煤企不受此项约束。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    4.4&nbsp;&nbsp;&nbsp;&nbsp; 同一主体重新入驻平台开放平台限制：\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   4.4.1&nbsp; 严重违规、资质造假被平台清退的，永久限制入驻；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 4.4.2&nbsp; 若卖家一自然年内主动退出<span>2</span>次，则自最后一次完成退出之日起<span>12</span>个月内限制入驻。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    4.5&nbsp;&nbsp;&nbsp;&nbsp; 续签限制：须在每年<span>3</span>月<span>1</span>日<span>18</span>时之前完成续签申请的提交，每年<span>3</span>月<span>20</span>日<span>18</span>时之前完成平台使用费的缴纳，如果上一年及下一年资费及资料未补足，平台将在每年<span>3</span>月<span>31</span>日<span>24</span>时终止煤企服务并下架煤炭。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <b>第五章 平台开放平台保证金<span>/</span>平台使用费<span>/</span>费率标准</b><b></b> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n   5.1 &nbsp; &nbsp; 保证金：卖家向平台缴纳的用以保证煤企规范运营及对煤炭和服务质量进行担保的金额。当卖家发生违约、违规行为时，平台可以依照与卖家签署的协议中相关约定及平台开放平台规则扣除相应金额的保证金作为违约金或给予买家的赔偿。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 5.1.1&nbsp; 保证金的补足、退还、扣除等依据卖家签署的相关协议及平台开放平台规则约定办理；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  5.1.2&nbsp; 平台开放平台各经营类目对应的保证金标准详见<span>《平台开放平台经营类目资费一览表》。</span> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n   5.2&nbsp;&nbsp;&nbsp;&nbsp; 平台使用费：卖家依照与平台签署的相关协议使用平台开放平台各项服务时缴纳的固定技术服务费用。平台开放平台各经营类目对应的平台使用费标准详见<span>《平台开放平台经营类目资费一览表》。</span>续签卖家的续展服务期间对应平台使用费须在每年<span>3</span>月<span>20</span>日<span>18</span>时前一次性缴纳；新签卖家须在申请入驻获得批准时一次性缴纳相应服务期间的平台使用费。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    5.2.1&nbsp;&nbsp; 平台使用费结算：\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  5.2.1.1卖家主动要求停止煤企服务的不返还平台使用费；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   5.2.1.2卖家因违规行为或资质造假被清退的不返还平台使用费；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n    5.2.1.3每个煤企的平台使用费依据相应的服务期计算并缴纳。服务开通之日在每月的<span>1</span>日至<span>15</span>日（含）间的，开通当月按一个月收取平台使用费，服务开通之日在每月的<span>16</span>日（含）至月底最后一日间的，开通当月不收取平台使用费；\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 5.2.1.4拥有独立煤企<span>ID</span>的为一个煤企，若卖家根据经营情况须开通多个煤企的，须按照煤企数量缴纳相应的平台使用费。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 5.3&nbsp;&nbsp;&nbsp;&nbsp; 费率：卖家根据经营类目在达成每一单交易时按比例（该比例在与卖家签署的相关协议中称为“技术服务费费率”或“毛利保证率”）向平台缴纳的费用。平台开放平台各经营模式各经营类目对应的费率标准详见<span>《平台开放平台经营类目资费一览表》。 </span> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <b>第六章 煤企服务期</b><b></b> \n</p>\n<p class="MsoNormal" style="text-align:left;">\n    6.1&nbsp;&nbsp;&nbsp;&nbsp; 卖家每个煤企的第一个服务期自服务开通之日起至最先到达的<span>3</span>月<span>31</span>日止，第二个服务期自<span>4</span>月<span>1</span>日起至次年<span>3</span>月<span>31</span>日止，第三个、第四个……服务期以此类推，以一年为周期，除非煤企或与卖家签署的相关协议提前终止。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  6.2&nbsp;&nbsp;&nbsp;&nbsp; 卖家每个煤企的服务开通之日以平台通知或系统记录的时间为准。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   6.3&nbsp;&nbsp;&nbsp;&nbsp; 卖家应在煤企每个服务期届满前<span>30</span>日向甲方提出续展的申请，缴纳续展服务期的平台使用费和提交其经营所需的全部有效资质，并经平台审核。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   6.4&nbsp;&nbsp;&nbsp;&nbsp; 卖家未提出续展申请或申请未通过平台审核的，自煤企服务期满之日起，平台开放平台将不再向卖家提供该煤企的任何服务。\n</p>\n<p class="MsoNormal" style="text-align:left;">\n <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  发布日期：<span>2013</span>年<span>11</span>月<span>19</span>日\n</p>\n<p class="MsoNormal" style="text-align:left;">\n 生效日期：<span>2014</span>年<span>1</span>月<span>1</span>日\n</p>\n<p class="MsoNormal" style="text-align:left;">\n   <br />\n</p>\n<p class="MsoNormal" style="text-align:left;">\n  <a name="help2267" id="help2267"></a><b>平台开放平台招商资质标准细则</b><b></b> \n</p>\n<p class="MsoNormal">\n   <span></span>&nbsp;\n</p>\n<img src="../data/upload/shop/article/help_store_04526250486031950.jpg" alt="image" /><img src="../data/upload/shop/article/help_store_04526250486031950.jpg" alt="image" /><img src="../data/upload/shop/article/help_store_04526250471329237.jpg" alt="image" />', '', 1399281053, 1, 1),
...
(99, 4, '资费标准', '<br />\r\n<p>\r\n  </p><h3 class="help_tit">\r\n       <strong>2014年开放平台重点招募企业</strong> \r\n   </h3>\r\n   <div class="help_box">\r\n      <p>\r\n         <img src="../data/upload/shop/editor/20140505170523_59415.jpg" alt="" /> \r\n       </p>\r\n    </div>\r\n\r\n<p>\r\n   <br />\r\n</p>\r\n<div class="help_box">\r\n    <p>\r\n     <br />\r\n  </p>\r\n    <p>\r\n     发布日期：2014年04月20日&nbsp;\r\n  </p>\r\n    <p>\r\n     修订日期：2014年05月01日\r\n    </p>\r\n</div>', '', 1399282379, 1, 1),
(101, 155, '签署入驻协议', '签署入驻协议', '', 1392949932, 99, 1),
(102, 156, '企业信息提交', '企业信息提交', '', 1392949961, 99, 1),
(103, 157, '平台审核资质', '平台审核资质', '', 1392949991, 99, 1),
(104, 158, '企业缴纳费用', '企业缴纳费用', '', 1392950031, 99, 1),
(105, 159, '煤企开通', '煤企开通', '', 1392950076, 99, 1),
(106, 255, '煤炭发布规则', '煤炭发布规则', '', 1392950396, 91, 1),
(107, 255, '煤炭规格及属性', '煤炭规格及属性', '', 1392950481, 92, 1),
(108, 255, '限时折扣说明', '限时折扣说明', '', 1392950523, 93, 1),
(109, 255, '订单煤炭退款', '订单煤炭退款', '', 1392950670, 94, 1),
...
(1, '出售禁售品', '销售商城禁止和限制交易规则下所规定的所有煤炭。', 1),
...
(1, '煤炭咨询', '&lt;p&gt;\r\n  请写明煤炭链接，或平台货号。\r\n&lt;/p&gt;\r\n&lt;p&gt;\r\n   如果您对煤炭规格、介绍等有疑问，可以在煤炭详情页“购买咨询”处发起咨询，会得到及时专业的回复。\r\n&lt;/p&gt;', 255),
(2, '订单咨询', '&lt;p&gt;\r\n  请写明要咨询的订单编号。\r\n&lt;/p&gt;\r\n&lt;p&gt;\r\n 如需处理交易中产生的纠纷，请选择投诉。\r\n&lt;/p&gt;', 255);
...
('arrival_notice', '到货通知提醒', 1, '您关注的煤炭 “{$goods_name}” 已经到货。<a href="{$goods_url}" target="_blank">点击查看煤炭</a>', 0, '【{$site_name}】您关注的煤炭 “{$goods_name}” 已经到货。', 0, '{$site_name}提醒：您关注的煤炭  “{$goods_name}” 已经到货。', '<p>\r\n   {$site_name}提醒：\r\n</p>\r\n<p>\r\n  您关注的煤炭 “{$goods_name}” 已经到货。\r\n</p>\r\n<p>\r\n <a href="{$goods_url}" target="_blank">点击查看煤炭</a> \r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p style="text-align:right;">\r\n {$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n   {$mail_send_time}\r\n</p>'),
('consult_goods_reply', '煤炭咨询回复提醒', 1, '您关于煤炭 “{$goods_name}”的咨询，企业已经回复。<a href="{$consult_url}" target="_blank">点击查看回复</a>', 0, '【{$site_name}】您关于煤炭 “{$goods_name}” 的咨询，企业已经回复。', 0, '{$site_name}提醒：您关于煤炭 “{$goods_name}”的咨询，企业已经回复。', '<p>\r\n  {$site_name}提醒：\r\n</p>\r\n<p>\r\n  您关注的煤炭“{$goods_name}” 已经到货。\r\n</p>\r\n<p>\r\n  <a href="{$consult_url}" target="_blank">点击查看回复</a> \r\n</p>\r\n<p>\r\n <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p style="text-align:right;">\r\n {$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n   {$mail_send_time}\r\n</p>\r\n<br />\r\n<div class="firebugResetStyles firebugBlockBackgroundColor">\r\n <div style="background-color:transparent ! important;" class="firebugResetStyles">\r\n  </div>\r\n</div>'),
...
('order_deliver_success', '煤炭出库提醒', 1, '您的订单已经出库。<a href="{$order_url}" target="_blank">点击查看订单</a>', 0, '【{$site_name}】您的订单已经出库。订单编号 {$order_sn}。', 0, '{$site_name}提醒：您的订单已经出库。订单编号 {$order_sn}。', '<p>\r\n    {$site_name}提醒：\r\n</p>\r\n<p>\r\n  您的订单已经出库。订单编号 {$order_sn}。<br />\r\n<a href="{$order_url}" target="_blank">点击查看订单</a>\r\n</p>\r\n<p>\r\n    <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p style="text-align:right;">\r\n {$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n   {$mail_send_time}\r\n</p>\r\n<br />'),
...
(6, 0, '关于ShopNC', 'shop/index.php?act=article&article_id=22', 2, 0, 255, 0),
...
(4, '{sitename} - 企业', 'ShopNC,{sitename}', 'ShopNC,{sitename}', 'brand'),
...
('consult_prompt', '因厂家更改煤炭包装、场地、附配件等不做提前通知，且每位咨询者购买、提问时间等不同。为此，客服给到的回复仅对提问者3天内有效，其他网友仅供参考！给您带来的不变还请谅解，谢谢！'),
...
('malbum_max_sum', '200'),
('md5_key', '549c64e575368b2eee2ef4793781a623'),
...
('stat_pricerange', ''),
('store_joinin_pic', 'a:2:{s:3:"pic";a:2:{i:1;s:18:"store_joinin_1.jpg";i:2;s:18:"store_joinin_2.jpg";}s:8:"show_txt";s:263:"ShopNC【B2B2C】平台提供各类专业管家服务，协助您开通煤企、运营煤企、组织营销活动及分析运营数据，悉心为您解答各类疑问，引导您按相关规则展开运营；我们将竭尽全力，为您的煤企保驾护航。";}'),
('subdomain_edit', '0'),
...
(2, '白金煤企', 200, 1000, 100, 6, 'default|style1|style2|style3|style4|style5', '200.00', '享受更多特权', 'editor_multimedia', 2),
(3, '钻石煤企', 0, 1000, 100, 6, 'default|style1|style2|style3|style4|style5', '1000.00', '', 'editor_multimedia', 100);
...
('complain', '煤炭被投诉提醒', 1, '您售出的煤炭被投诉，等待企业申诉。投诉单编号：{$complain_id}。', 1, 0, '【{$site_name}】您售出的煤炭被投诉，等待企业申诉。投诉单编号：{$complain_id}。', 0, 0, '{$site_name}提醒：您售出的煤炭被投诉，等待企业申诉。投诉单编号：{$complain_id}。', '<p>\r\n  {$site_name}提醒：\r\n</p>\r\n<p>\r\n  您售出的煤炭被投诉，等待企业申诉。投诉单编号：{$complain_id}。\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p style="text-align:right;">\r\n {$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n   {$mail_send_time}\r\n</p>\r\n<p>\r\n    <br />\r\n</p>', 0),
('goods_storage_alarm', '煤炭库存预警', 1, '您的煤炭库存不足，请及时补货。平台货号：{$common_id}，SKU：{$sku_id}。', 1, 0, '【{$site_name}】您的煤炭库存不足，请及时补货。平台货号：{$common_id}，SKU：{$sku_id}。', 0, 0, '{$site_name}提醒：您的煤炭库存不足，请及时补货。', '<p>\r\n {$site_name}提醒：\r\n</p>\r\n<p>\r\n  您的煤炭库存不足，请及时补货。平台货号：{$common_id}，SKU：{$sku_id}。\r\n</p>\r\n<p>\r\n  点击下面链接查看煤炭详细信息\r\n</p>\r\n<p>\r\n   <a href="http://{$shop_site_url}/index.php?act=goods&amp;op=index&amp;goods_id={$sku_id}" target="_blank">http://{$shop_site_url}/index.php?act=goods&amp;op=index&amp;goods_id={$sku_id}</a> \r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p style="text-align:right;">\r\n {$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n   {$mail_send_time}\r\n</p>\r\n<p>\r\n    <br />\r\n</p>\r\n<br />', 0),
('goods_verify', '煤炭审核失败提醒', 1, '您的煤炭没有通过管理员审核，原因：“{$remark}”。平台货号：{$common_id}。', 1, 0, '【{$site_name}】您的煤炭没有通过管理员审核，原因：“{$remark}”。平台货号：{$common_id}。', 0, 0, '{$site_name}提醒：您的煤炭没有通过管理员审核。', '<p>\r\n   {$site_name}提醒：\r\n</p>\r\n<p>\r\n  您的煤炭没有通过管理员审核，原因：“{$remark}”。平台货号：{$common_id}。\r\n </p><p>\r\n     <br />\r\n  </p>\r\n    <p>\r\n     <br />\r\n  </p>\r\n    <p style="text-align:right;">\r\n       {$site_name}\r\n    </p>\r\n    <p style="text-align:right;">\r\n       {$mail_send_time}\r\n   </p>', 0),
('goods_violation', '煤炭违规被下架', 1, '您的煤炭被违规下架，原因：“{$remark}”。平台货号：{$common_id}。', 1, 0, '【{$site_name}】您的煤炭被违规下架，原因：“{$remark}”。平台货号：{$common_id}。', 0, 0, '{$site_name}提醒：您的煤炭被违规下架。', '<p>\r\n {$site_name}提醒：\r\n</p>\r\n<p>\r\n  您的煤炭被违规下架。，原因：“{$remark}”。平台货号：{$common_id}。\r\n</p>\r\n<p>\r\n <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p style="text-align:right;">\r\n {$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n   {$mail_send_time}\r\n</p>\r\n<p>\r\n    <br />\r\n</p>', 0),
...
('store_cost', '煤企消费提醒', 1, '您有一条新的煤企消费记录，金额：{$price}，操作人：{$seller_name}，备注：{$remark}。', 1, 0, '【{$site_name}】您有一条新的煤企消费记录，金额：{$price}，操作人：{$seller_name}，备注：{$remark}。', 0, 0, '{$site_name}提醒：您有一条新的煤企消费记录。', '<p>\r\n    {$site_name}提醒：\r\n</p>\r\n<p>\r\n  您有一条新的煤企消费记录，金额：{$price}，操作人：{$seller_name}，备注：{$remark}。\r\n</p>\r\n<p>\r\n    <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p style="text-align:right;">\r\n {$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n   {$mail_send_time}\r\n</p>', 0),
('store_expire', '煤企到期提醒', 1, '你的煤企即将到期，请及时续期。', 1, 0, '【{$site_name}】你的煤企即将到期，请及时续期。', 0, 0, '{$site_name}提醒：你的煤企即将到期，请及时续期。', '<p>\r\n    {$site_name}提醒：\r\n</p>\r\n<p>\r\n  你的煤企即将到期，请及时续期。\r\n</p>\r\n<p>\r\n  <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p>\r\n   <br />\r\n</p>\r\n<p style="text-align:right;">\r\n {$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n   {$mail_send_time}\r\n</p>\r\n<p>\r\n    <br />\r\n</p>', 0);
...
(23, 2, 'array', 'act', '', '活动图片'),
(25, 2, 'array', 'recommend_list', '', '煤炭推荐'),
(28, 2, 'array', 'adv', '', '广告图片'),
(29, 2, 'array', 'brand_list', '', '企业推荐'),
(31, 3, 'array', 'tit', '', '标题图片'),
