...
$lang['store_deliver_express_note']			= '您可以通過"發貨設置-><a href="index.php?act=store_deliver&op=express" target="_parent" >預設物流公司</a>"添加或修改常用貨運物流。免運或自提煤炭可切換下方<span class="red">[無需物流運輸服務]</span>選項卡並操作。';
...
$lang['store_deliver_no_deliver_tips']		= '如果訂單中的煤炭無需物流運送(如綫下交易或虛擬物品)，您可以直接確認提交';
