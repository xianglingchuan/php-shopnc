  ...
  <form id="delivery_joinin" method="post" enctype="multipart/form-data" action="<?php echo DELIVERY_SITE_URL?>/index.php?act=joinin_again&op=edit_delivery">
    ...
    <dl class="r2">
      ...
      <dd>
        ...
        <input class="input-txt tip" type="text" name="daddressname" id="daddressname" value="<?php echo $output['dpoint_info']['dlyp_address_name']?>" title="服务站名称请使用您的实体煤铺或经营场所、办公地点名称，例如“某某超市”、“某某小区物业”，便于收货人自提时使用；最多不超过15位字符。">
      </dd>
      <dd id="region">
