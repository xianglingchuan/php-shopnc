        ...
        <table class="tb-type1 noborder search left">
          <tbody>
            <tr>
         	  ...
         	  <tr>
         	  	<td>煤炭名称<input class="txt-long" type="text" name="goods_name" value="<?php echo $_GET['goods_name'];?>" /></td>
    ...
    <tbody>
      ...
      <tr>
        ...
        <ul>
        	...
        	<li>以下列表为符合搜索条件的有效订单中所有煤炭数据，及其时间段内的销量、下单量、下单总金额</li>
            <li>点击每列旁边的箭头对列表进行排序，默认按照“下单煤炭件数”降序排列</li>
        </ul></td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead sortbar-array" >
	      ...
	      <th class="align-center"><a nc_type="orderitem" data-param='{"orderby":"goodsnum"}' class="<?php echo (!$output['orderby'] || $output['orderby']=='goodsnum desc')?'selected desc':''; echo $output['orderby']=='goodsnum asc'?'selected asc':''; ?>">下单煤炭件数<i></i></a></th>
