...
<div class="page">
  ...
  <div class="stat-info"><span>上架煤炭数：<strong><?php echo intval($output['goods_on_allnum']); ?></strong></span><span>下单煤炭数：<strong><?php echo intval($output['order_goods_num']); ?></strong></span><span>下单单数：<strong><?php echo intval($output['order_num']); ?></strong></span><span>下单会员数：<strong><?php echo intval($output['order_buyer_num']); ?></strong></span><span>合计金额：<strong><?php echo number_format($output['order_amount'],2); ?></strong>元</span></div>
  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead">
        ...
        <th class="align-center" style="width:30%">煤炭名称</th>
