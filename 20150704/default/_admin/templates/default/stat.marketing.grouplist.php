...
<div style="border:1px #D9D9D9 solid; padding:10px; width:98%;">
    <div style="text-align:right;">
    	...
    	<a href="javascript:void(0);" id="glistsearchbtn" class="btn-search tooltip" title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
    </div>
...
$(function () {
	...
	$("#gname").change(function(){
		var gname = $(this).val();
		$("#glistsearchbtn").attr('href','index.php?act=stat_marketing&op=grouplist&t=<?php echo $output['searchtime'];?>&gname='+gname);
