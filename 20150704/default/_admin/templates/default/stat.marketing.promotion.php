    ...
    <tbody>
      ...
      <tr>
        ...
        <ul>
        	...
        	<li>走势图展现了各种促销活动时间段内有效订单的下单量、下单总金额、下单煤炭数走势对比</li>
            <li>饼图则展现了各种促销活动时间段内有效订单的下单量、下单总金额、下单煤炭数占总数的比例</li>
            <li>统计列表则清晰的展现了各种促销活动的下单量、下单总金额、下单煤炭数的总数值</li>
        </ul></td>
      </tr>
    </tbody>
  </table>
  ...
  <div id="stat_tabs" class="w100pre close_float ui-tabs">
    <div class="close_float tabmenu">
      <ul class="tab pngFix">
        ...
        <li><a href="#goodsnum_div" nc_type="showlinelabels" data-param='{"type":"goodsnum"}'>下单煤炭数</a></li>
  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead">
        ...
        <th class="align-center">下单煤炭数</th>
