...
<div class="page">
  ...
  <table class="table tb-type2 new-general">
	...
	<tbody>
		<tr>
			...
			<td>
				下单煤炭数&nbsp;<i title="有效订单包含的煤炭总数量" class="tip icon-question-sign"></i>
				<br><b><?php echo $output['statnew_arr']['ordergoodsnum'];?></b>
			</td>
		</tr>
		<tr>
			<td>
				平均价格&nbsp;<i title="有效订单包含煤炭的平均单价" class="tip icon-question-sign"></i>
		...
		<tr>
			...
			<td>
				新增煤炭&nbsp;<i title="期间内新增煤炭总数" class="tip icon-question-sign"></i>
				<br><b><?php echo $output['statnew_arr']['newgoods'];?></b></td>
			<td>
				煤炭数量&nbsp;<i title="平台所有煤炭的数量" class="tip icon-question-sign"></i>
  ...
  <div class="w50pre floatleft" style="margin-left: 50px;">
  	<table class="table tb-type2">
    	<thead class="thead">
    		<tr class="space">
    			<th colspan="15">7日内煤炭销售TOP30&nbsp;<i title="从昨天开始7日内热销煤炭前30名" class="tip icon-question-sign"></i></th>
    		</tr>
    	</thead>
    	<tbody>
    		<tr>
