...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>三号线记录</h3>
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span>三号线记录</span></a></li>
        <li><a href="index.php?act=chat_log&op=msg_log"><span>三号线内容</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li>为使查询信息更准确，请输入交流双方的完整会员名——登录账号。</li>
            <li>可查询“<?php echo $output['minDate']; ?>”到“<?php echo $output['maxDate']; ?>”的90天内交流记录。</li>
          </ul></td>
      </tr>
    </tbody>
  </table>
