...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="<?php echo urlAdmin('promotion_booth', 'goods_list');?>"><span>煤炭列表</span></a></li>
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
            ...
            <td class="vatop tips">购买单位为月(30天)，购买后卖家可以在所购买周期内推荐煤炭，在煤炭列表热卖煤炭中随机显示。</td>
        </tr>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="promotion_booth_goods_sum">允许推荐煤炭最大数量<?php echo $lang['nc_colon'];?></label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform">
            ...
            <td class="vatop tips">每个店铺推荐煤炭的最大数量。</td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
