...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>交流内容</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=chat_log&op=chat_log"><span>三号线记录</span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span>三号线内容</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li>可查询“<?php echo $output['minDate']; ?>”到“<?php echo $output['maxDate']; ?>”的90天内三号线记录。</li>
          </ul></td>
      </tr>
    </tbody>
  </table>
