...
class store_settingControl extends BaseSellerControl {
	...
	public function store_settingOp(){
		...
		$store_id = $_SESSION['store_id'];//当前煤企ID
		/**
		 * 获取煤企信息
		 */
		...
		$store_domain_times = intval($store_info['store_domain_times']);//煤企已修改次数
	...
	private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
            ...
            5=>array('menu_key'=>'store_theme','menu_name'=>'煤企主题','menu_url'=>'index.php?act=store_setting&op=theme'),
        );
