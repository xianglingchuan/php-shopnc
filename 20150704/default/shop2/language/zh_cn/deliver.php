...
$lang['store_deliver_express_note']			= '您可以通过"发货设置-><a href="index.php?act=store_deliver_set&op=express" target="_parent" >默认物流公司</a>"添加或修改常用货运物流。免运或自提煤炭可切换下方<span class="red">[无需物流运输服务]</span>选项卡并操作。';
...
$lang['store_deliver_no_deliver_tips']		= '如果订单中的煤炭无需物流运送，您可以直接点击确认';
