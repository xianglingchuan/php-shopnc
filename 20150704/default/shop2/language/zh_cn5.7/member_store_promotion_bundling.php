 ...
 * 添加活动
 */
$lang['bundling_add_explain1']				= '您只能发布%d个优惠套装活动；每个活动最多可以添加%d个煤炭。';
$lang['bundling_add_explain2']				= '每个活动最多可以添加%d个煤炭。';
$lang['bundling_add_goods_explain']			= '搭配销售的煤炭可上下<br/>拖移煤炭列可自定义显<br/>示排序；编辑、删除、<br/>排序等操作提交后生效。';
$lang['bundling_goods']						= '煤炭';
$lang['bundling_show_name']					= '显示名称';
$lang['bundling_cost_price']				= '原价';
$lang['bundling_cost_price_note']			= '&nbsp;(已添加搭配煤炭的默认价格总计)';
$lang['bundling_goods_add']					= '添加煤炭';
$lang['bundling_add_price']					= '优惠套装价格';
$lang['bundling_add_price_title']			= '自定义优惠套装煤炭的优惠价格总计';
...
$lang['bundling_add_goods_error']			= '请选择2件及以上的煤炭';
...
$lang['bundling_add_goods_show_note']		= '煤炭已下架，请重新上架或选择其他煤炭';

/**
 * 添加套餐煤炭
 */
$lang['bundling_goods_store_class']			= '煤企分类';
$lang['bundling_goods_name']				= '煤炭名称';
$lang['bundling_goods_code']				= '货号';
$lang['bundling_goods_price']				= '价格';
$lang['bundling_goods_storage']				= '库存';
$lang['bundling_goods_storage_not_enough']	= '库存不足，不能添加煤炭。';
$lang['bundling_goods_add_bundling']		= '添加到优惠套装';
$lang['bundling_goods_add_bundling_exit']	= '从优惠套装移除';
$lang['bundling_goods_add_enough_prompt']	= '您已经添加了%d个，不能在继续添加煤炭。';
 ...
 * 活动列表
 */
$lang['bundling_list_goods_count']			= '煤炭数量';