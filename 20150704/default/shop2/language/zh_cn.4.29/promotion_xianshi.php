...
$lang['promotion_unavailable'] = '煤炭促销功能尚未开启';
...
$lang['promotion_goods_manage'] = '煤炭管理';
$lang['promotion_add_goods'] 	= '添加煤炭';
...
$lang['xianshi_quota_goods_limit'] = '煤炭限制';
...
$lang['goods_add'] = '添加煤炭';
$lang['choose_goods'] = '选择活动煤炭';
$lang['goods_name'] = '煤炭名称';
$lang['goods_store_price'] = '煤炭价格';
$lang['xianshi_goods_selected'] = '已选煤炭';
$lang['xianshi_publish'] = '发布活动';
$lang['ensure_publish'] = '确认发布该活动?';
$lang['xianshi_no_goods'] = '您还没有选择活动煤炭';
$lang['xianshi_goods_exist'] = '已参加';

$lang['xianshi_price'] = '购买限时折扣所需金币数';
$lang['xianshi_explain1'] = '1、点击购买套餐和套餐续费按钮可以购买或续费套餐';
$lang['xianshi_explain2'] = '2、点击添加活动按钮可以添加限时折扣活动，点击管理按钮可以对限时折扣活动内的煤炭进行管理';
$lang['xianshi_explain3'] = '3、点击删除按钮可以删除限时折扣活动';
$lang['xianshi_manage_goods_explain1'] = '1、限时折扣煤炭的时间段不能重叠';
$lang['xianshi_manage_goods_explain2'] = '2、点击添加煤炭按钮可以搜索并添加参加活动的煤炭，点击删除按钮可以删除该煤炭';
...
$lang['xianshi_name_explain'] = '活动名称将显示在限时折扣活动列表中，方便企业管理使用，最多可输入25个字符。';
$lang['xianshi_title_explain'] = '活动标题是企业对限时折扣活动的别名操作，请使用例如“新品打折”、“月末折扣”类短语表现，最多可输入10个字符；<br/>非必填选项，留空煤炭优惠价格前将默认显示“限时折扣”字样。';
$lang['xianshi_explain_explain'] = '活动描述是企业对限时折扣活动的补充说明文字，在煤炭详情页-优惠信息位置显示；<br/>非必填选项，最多可输入30个字符。';
...
$lang['xianshi_add_success'] = '限时折扣活动添加成功，请您选择要参加该活动的煤炭，并发布该活动';
$lang['xianshi_active_status'] = '活动状态';
$lang['xianshi_add_fail'] = '限时折扣活动添加失败';
$lang['xianshi_goods_none'] = '您还没有添加活动煤炭';
$lang['xianshi_goods_add_success'] = '限时折扣活动煤炭添加成功';
$lang['xianshi_goods_add_fail'] = '限时折扣活动煤炭添加失败';
$lang['xianshi_goods_delete_success'] = '限时折扣活动煤炭删除成功';
$lang['xianshi_goods_delete_fail'] = '限时折扣活动煤炭删除失败';
$lang['xianshi_goods_cancel_fail'] = '限时折扣活动煤炭取消失败';
$lang['xianshi_goods_limit_error'] = '已经超过了活动煤炭数限制';
$lang['xianshi_goods_is_exist'] = '该煤炭已经参加了本期限时折扣，请选择其它煤炭';
