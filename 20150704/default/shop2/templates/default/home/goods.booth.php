  ...
  <ul class="nch-booth-list squares">
    ...
    <li nctype_goods="<?php echo $value['goods_id'];?>" nctype_store="<?php echo $value['store_id'];?>">
        ...
        <?php }?>
          ...
          <div class="goods-price" title="煤炭价格<?php echo $lang['nc_colon'].$lang['currency'].$value['goods_promotion_price'];?>"><?php echo $lang['currency'];?><?php echo $value['goods_promotion_price'];?></div>
    </li>
    <?php }?>
  </ul>
  <?php }?>
