...
<div class="alert alert-block mt10">
  <ul>
    ...
    <li>2. 设置后的线下商铺信息将显示于“虚拟团购”活动详情页面右侧店铺介绍处，但不会影响原有线上店铺信息。</li>
  ...
  <form id="add_form" action="index.php?act=store_live&op=store_live" method="post" >
    ...
    <dl>
      ...
      <dd>
        ...
        <span></span>
        <p class="hint">线下店铺名称仅供线下“虚拟团购”活动使用，不影响原有线上店铺名称，商铺名称长度最多可输入30个字符。未填写时将显示线上店铺名称。</p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <span></span>
        <p class="hint">线下店铺电话用于“虚拟团购”活动中，买家与企业进行联系沟通使用，请认真填写。未填写内容时将默认显示线上店铺所留企业电话号码。</p>
      </dd>
    </dl>
    <dl>
