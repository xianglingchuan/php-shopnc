...
<ul class="goods-list" style="width:760px;">
  ...
  <li>
    ...
    <a nctype="btn_add_groupbuy_goods" data-goods-commonid="<?php echo $val['goods_commonid'];?>" href="javascript:void(0);" class="ncsc-btn-mini ncsc-btn-green"><i class="icon-ok-circle "></i>选择为团购煤炭</a> </li>
  <?php } ?>
</ul>
