...
<div class="alert alert-info mt10" style="clear:both;">
    ...
    <li>
		...
		<span class="w210 fl h30" style="display:block;">
			<i title="店铺从昨天开始最近30天有效订单的总煤炭数量" class="tip icon-question-sign"></i>
    ...
    <li>
    	...
    	<span class="w210 fl h30" style="display:block;">
    		<i title="店铺从昨天开始最近30天有效订单煤炭的平均每个煤炭的成交价格" class="tip icon-question-sign"></i>
    		平均价格：<strong><?php echo $output['statnew_arr']['avggoodsprice'].$lang['currency_zh'];?></strong>
    	</span>
    	<span class="w210 fl h30" style="display:block;">
    		<i title="店铺所有煤炭的总收藏次数" class="tip icon-question-sign"></i>
    		煤炭收藏量：<strong><?php echo $output['statnew_arr']['gcollectnum'];?></strong>
    	</span>
    	<span class="w210 fl h30" style="display:block;">
    		<i title="店铺拥有煤炭的总数（仅计算煤炭种类，不统计库存）" class="tip icon-question-sign"></i>
...
<div class="w450 fl mr50">
	<div class="alert alert-info" style="margin-bottom:0px;"><strong>建议推广煤炭</strong>
		&nbsp;<i title="统计店铺从昨天开始7日内热销煤炭前30名，建议推广以下煤炭，提升推广回报率" class="tip icon-question-sign"></i>
	</div>
...
<div class="w450 fl">
	<div class="alert alert-info" style="margin-bottom:0px;"><strong>同行热卖</strong>
		&nbsp;<i title="拥有相同经营类目同行店铺热销煤炭推荐，了解行业热卖便于调整煤炭结构" class="tip icon-question-sign"></i>
	</div>
    <table class="ncsc-default-table">
      <thead>
        <tr class="sortbar-array">
