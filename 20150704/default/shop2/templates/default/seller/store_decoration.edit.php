...
<div class="ncsc-path"><i class="icon-desktop"></i>登陆企业管理中心<i class="icon-angle-right"></i>店铺<i class="icon-angle-right"></i>店铺装修<i class="icon-angle-right"></i>页面设计</div>
...
<div id="dialog_module_goods" class="eject_con dialog-decoration-edit" style="display:none;">
  <div class="alert">
    <ul>
      <li>1. 搜索店铺内在售煤炭并“选择添加”，设置窗口上部将出现已选择的煤炭列表，也可对其进行“取消选择”操作，点击保存设置后生效。</li>
  ...
  <div class="decoration-search-goods">
    <div class="search-bar">输入煤炭关键字：
      ...
      <a id="btn_module_goods_search" class="ncsc-btn" href="javascript:void(0);">搜索</a><span class="ml10 orange">小提示： 留空搜索显示店铺全部在售煤炭，每页显示10个。</span></div>
