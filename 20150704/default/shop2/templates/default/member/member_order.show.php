  ...
  <div class="ncm-order-info">
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        ...
        <li>3. 看一看<a href="<?php echo urlShop('show_store','index',array('store_id'=>$output['order_info']['store_id']), $output['order_info']['extend_store']['store_domain']);?>" class="ncm-btn-mini">该店铺</a>中有什么新煤炭上架。</li>
      </ul>
    </div>
    <?php } else { ?>
    <div class="ncm-order-condition">
