  ...
  <div id="payment_list" class="ncc-candidate-items" style="display:none">
    <ul>
      ...
      <li>
        ...
        <a id="show_goods_list" style="display: none" class="ncc-payment-showgoods" href="javascript:void(0);"><i class="icon-truck"></i>货到付款 (<span data-cod-nums="offline"><?php echo count($output['pay_goods_list']['offline']);?></span>种煤炭) + <i class="icon-credit-card"></i>在线支付 (<span data-cod-nums="online"><?php echo count($output['pay_goods_list']['online']);?></span>种煤炭)</a>
      </li>
    </ul>
...
<div id="confirm_offpay_goods_list" style="display: none;">
  <dl class="ncc-offpay-list" data-hideshow="offline">
    <dt>以下煤炭支持<strong>货到付款</strong></dt>
    <dd>
  ...
  <dl class="ncc-offpay-list" data-hideshow="online">
    <dt>以下煤炭支持<strong>在线支付</strong></dt>
    <dd>
