...
CREATE TABLE `#__micro_comment` (
  ...
  `comment_object_id` int(10) unsigned NOT NULL COMMENT '推荐煤炭编号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='微商城煤炭评论表';
...
CREATE TABLE `#__micro_goods` (
  ...
  `commend_goods_id` int(10) unsigned NOT NULL COMMENT '推荐煤炭编号',
  `commend_goods_commonid` int(10) unsigned NOT NULL COMMENT '煤炭公共表id',
  `commend_goods_store_id` int(10) unsigned NOT NULL COMMENT '推荐煤炭店铺编号',
  `commend_goods_name` varchar(100) NOT NULL COMMENT '推荐煤炭名称',
  `commend_goods_price` decimal(11,2) NOT NULL COMMENT '推荐煤炭价格',
  `commend_goods_image` varchar(100) NOT NULL COMMENT '推荐煤炭图片',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='微商城推荐煤炭表随心看';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='微商城煤炭随心看分类表';

CREATE TABLE `#__micro_goods_relation` (
  `relation_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '关系编号',
  `class_id` int(10) unsigned NOT NULL COMMENT '微商城煤炭分类编号',
  `shop_class_id` int(10) unsigned NOT NULL COMMENT '商城煤炭分类编号',
  PRIMARY KEY (`relation_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='微商城煤炭分类和商城煤炭分类对应关系';
