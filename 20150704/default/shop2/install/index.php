...
<div class="header">
  <div class="layout">
    ...
    <div class="version">版本: 2014.08.20.6680</div>
  </div>
</div>
...
function step3(&$install_error,&$install_recover){
    ...
    $db->query("INSERT INTO {$db_prefix}store (`store_id`,`store_name`,`grade_id`,`member_id`,`member_name`,`seller_name`,`store_state`,`store_time`,`is_own_shop`,`bind_all_gc`) VALUES ('1','{$store_name}','0','1','{$member_name}','{$seller_name}','1', '". time() ."', '1', '1')");
